...
var EditarComportamientoPago =
/*#__PURE__*/
function (_React$Component) {
  _inherits(EditarComportamientoPago, _React$Component);

  function EditarComportamientoPago(props) {
    var _this;

    _classCallCheck(this, EditarComportamientoPago);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EditarComportamientoPago).call(this, props));
    _this.state = {
  ...
  _createClass(EditarComportamientoPago, [{
    ...
    value: function saveCriteriaClasification() {
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("update ComportamientoPago set prestamoTablaID = " + prestamoTablaID + ", planPagoTablaID = " + planPagoTablaID + ", idClientePrestamoCampoID = " + idClientePrestamoCampoID + ", numeroPrestamoCampoID = " + numeroPrestamoCampoID + ", pagoCapitalPrestamoCampoID = " + pagoCapitalPrestamoCampoID + ", pagoImpuestosPrestamoCampoID = " + pagoImpuestosPrestamoCampoID + ", fechaPrestamoCampoID = " + fechaPrestamoCampoID + ", idClientePlanPagoCampoID = " + idClientePlanPagoCampoID + ", numeroPlanPagoCampoID = " + numeroPlanPagoCampoID + ", pagoCapitalPlanPagoCampoID = " + pagoCapitalPlanPagoCampoID + ", pagoImpuestosPlanPagoCampoID = " + pagoImpuestosPlanPagoCampoID + ", fechaPlanPagoCampoID = " + fechaPlanPagoCampoID + ", comparacionEsPlanPago = '" + comparacionEsPlanPago + "' where ID = " + _this3.props.comportamientoPagoSel.ID, function (err, result) {
          if (err) {
            if (!rolledBack) {
              console.log(err);
              transaction.rollback(function (err) {});
            ...
            transaction.commit(function (err) {
              ...
              _this3.showSuccesMessage("Exito", "Comportamiento de Pago modificado con éxito.");
            });
          }
        });
      }); // fin transaction camposPrestamos
    ...
    value: function render() {
      if (this.state.mostrarComponente.localeCompare("selTablaPrestamo") == 0) {
        ...
        }, "Guardar")), _react["default"].createElement("br", null), this.state.mensajeModal.mostrarMensaje ? _react["default"].createElement(MessageModal, {
  ...
  return EditarComportamientoPago;
}(_react["default"].Component);

exports["default"] = EditarComportamientoPago;
//# sourceMappingURL=EditarComportamientoPago.js.map
