...
function (_React$Component) {
  ...
  function FuenteDatoExcel() {
    _classCallCheck(this, FuenteDatoExcel);

    return _possibleConstructorReturn(this, _getPrototypeOf(FuenteDatoExcel).apply(this, arguments));
  }
  ...
  _createClass(FuenteDatoExcel, [{
    ...
    value: function render() {
      return _react["default"].createElement("div", null, _react["default"].createElement("div", {
        ...
        htmlFor: "ubicacionArchivo",
        className: "col-form-label"
      }, "COLUMNA-FILA-RANGOCELDAS-:")), _react["default"].createElement("div", {
        className: "col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9 form-group",
        style: {
          display: "flex",
          alignItems: "center",
