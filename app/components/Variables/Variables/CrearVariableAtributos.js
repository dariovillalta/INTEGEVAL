...
var CrearVariableAtributos =
/*#__PURE__*/
function (_React$Component) {
  _inherits(CrearVariableAtributos, _React$Component);

  function CrearVariableAtributos(props) {
    var _this;

    _classCallCheck(this, CrearVariableAtributos);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CrearVariableAtributos).call(this, props));
    _this.state = {
      titulo: _this.props.titulo,
      mostrarCrearEscalar: _this.props.mostrarCrearEscalar
    };
  ...
  _createClass(CrearVariableAtributos, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        className: "col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 onHoverOpcionUmbral",
        style: {
          height: "100%",
          width: "100%",
          display: "flex",
      ...
      }, this.props.titulo)), _react["default"].createElement("br", null), this.props.mostrarCrearEscalar ? _react["default"].createElement("div", {
        className: "row"
      }, _react["default"].createElement("div", {
        ...
        }, "Condiciones para el C\xE1lculo"), _react["default"].createElement("hr", null));
      }))));
    }
  }]);

  return CrearVariableAtributos;
}(_react["default"].Component);

exports["default"] = CrearVariableAtributos;
//# sourceMappingURL=CrearVariableAtributos.js.map
