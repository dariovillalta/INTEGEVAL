...
function (_React$Component) {
  ...
  function EditarVariable(props) {
    ...
    _this.state = {
      nombreVariable: _this.props.nombreVariable,
      descripcionVariable: _this.props.descripcionVariable,
      esObjetoVariable: _this.props.esObjetoVariable,
      objetoPadreID: _this.props.objetoPadreID,
      mostrarEsObjeto: _this.props.esObjetoVariable,
      campos: []
    };
    console.log("this.state.mostrarEsObjeto");
    console.log(_this.state.mostrarEsObjeto);
  ...
  _createClass(EditarVariable, [{
    ...
    value: function crearAtributoDeObjeto(nombre) {
      var _this3 = this;
    ...
    value: function render() {
      return _react["default"].createElement("div", null, _react["default"].createElement("div", {
        ...
        defaultValue: this.state.nombreVariable
      }))), _react["default"].createElement("div", {
        className: "row",
        style: {
          width: "100%"
        ...
        rows: "3",
        defaultValue: this.state.descripcionVariable
      }))), _react["default"].createElement("br", null), _react["default"].createElement("div", {
        className: "row",
        style: {
          width: "100%"
        ...
        type: "checkbox",
        defaultChecked: this.state.esObjetoVariable,
        name: "esObjetoVariable",
        id: "esObjetoVariable",
        onClick: this.cambioAObjeto,
        key: "esObjetoVariable"
        ...
        className: "col-form-label"
      }, "Objeto Variable Padre:")), _react["default"].createElement("div", {
        className: "col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9"
      }, _react["default"].createElement("select", {
        className: "form-control",
        id: "objetoPadreID",
        defaultValue: this.state.idObjetoPadreVariable,
        key: "objetoPadreID"
      }, _react["default"].createElement("option", {
        value: "-1"
      }, "Ninguno")))), _react["default"].createElement("br", null), _react["default"].createElement("a", {
      ...
      }, "Guardar")), _react["default"].createElement("br", null), _react["default"].createElement("div", {
        className: "row",
        style: {
          width: "100%",
          border: "1px solid #e6e6f2"
        }
      }, _react["default"].createElement(_CrearVariableOpciones["default"], {
