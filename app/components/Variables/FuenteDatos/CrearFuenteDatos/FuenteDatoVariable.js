...
function (_React$Component) {
  ...
  function FuenteDatoVariable(props) {
    ...
    _this.revisarSeleccionCampoOperacionAntesCondiciones = _this.revisarSeleccionCampoOperacionAntesCondiciones.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(FuenteDatoVariable, [{
    ...
    key: "revisarSeleccionCampoOperacionAntesCondiciones",
    value: function revisarSeleccionCampoOperacionAntesCondiciones() {
      if (columnaSeleccionada.valor != undefined) {
        if (operacionSeleccionada.valor != undefined) {
          if (this.state.reglas.length == 0) {
            var copiaAntigua = _toConsumableArray(this.state.reglas);
            /*
            ATRIBUTOS REGLA
                -reglaPadreID
                -variablePadreID
