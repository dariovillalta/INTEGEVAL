...
var VerResultadosVariable =
/*#__PURE__*/
function (_React$Component) {
  _inherits(VerResultadosVariable, _React$Component);

  function VerResultadosVariable(props) {
    var _this;

    _classCallCheck(this, VerResultadosVariable);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(VerResultadosVariable).call(this, props));
  ...
  _createClass(VerResultadosVariable, [{
    key: "styleDate",
  ...
  return VerResultadosVariable;
}(_react["default"].Component);

exports["default"] = VerResultadosVariable;
//# sourceMappingURL=VerResultadosVariable.js.map
