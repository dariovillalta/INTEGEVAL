...
var _SeleccionarFechas = _interopRequireDefault(require("./SeleccionarFechas.js"));

var _Filtro = _interopRequireDefault(require("./Filtro.js"));
...
var ImportacionResultadosHome =
/*#__PURE__*/
function (_React$Component) {
  _inherits(ImportacionResultadosHome, _React$Component);

  function ImportacionResultadosHome(props) {
    var _this;

    _classCallCheck(this, ImportacionResultadosHome);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ImportacionResultadosHome).call(this, props));
    _this.state = {
  ...
  _createClass(ImportacionResultadosHome, [{
    key: "goCreateFilters",
  ...
  return ImportacionResultadosHome;
}(_react["default"].Component);

exports["default"] = ImportacionResultadosHome;
//# sourceMappingURL=ImportacionResultadosHome.js.map
