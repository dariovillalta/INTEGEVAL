...
module.exports = function toDataURL(_svg, type, options) {
  ...
  function exportSVG() {
    ...
    debug(type + " length: " + svg_dataurl.length); // NOTE double data carrier
  ...
  function exportImage(type) {
    ...
    svg_img.onload = function () {
      ...
      ctx.drawImage(svg_img, 0, 0); // SECURITY_ERR WILL HAPPEN NOW
  ...
  function exportImageCanvg(type) {
    ...
    var svg_xml = XMLSerialize(_svg); // NOTE: canvg gets the SVG element dimensions incorrectly if not specified as attributes
    ...
    if (keepBB) var bb = _svg.getBBox(); // NOTE: this canvg call is synchronous and blocks
...
//# sourceMappingURL=svg_todataurl.js.map
