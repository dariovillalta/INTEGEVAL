...
var DescargarReporteria =
/*#__PURE__*/
function (_React$Component) {
  _inherits(DescargarReporteria, _React$Component);

  function DescargarReporteria(props) {
    var _this;

    _classCallCheck(this, DescargarReporteria);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(DescargarReporteria).call(this, props));
    _this.state = {
  ...
  _createClass(DescargarReporteria, [{
    ...
    value: function render() {
      if (!this.state.seleccionoFiltro) {
        ...
        return _react["default"].createElement("div", null, _react["default"].createElement(_DescargarReporteArchivo["default"], {
  ...
  return DescargarReporteria;
}(_react["default"].Component);

exports["default"] = DescargarReporteria;
//# sourceMappingURL=DescargarReporteria.js.map
