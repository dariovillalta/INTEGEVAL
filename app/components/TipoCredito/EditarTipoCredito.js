...
var EditarTipoCredito =
/*#__PURE__*/
function (_React$Component) {
  _inherits(EditarTipoCredito, _React$Component);

  function EditarTipoCredito(props) {
    var _this;

    _classCallCheck(this, EditarTipoCredito);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EditarTipoCredito).call(this, props));
    _this.state = {
  ...
  _createClass(EditarTipoCredito, [{
        ...
        if (descripcion.length < 701) {
          if (!isNaN(tipoCreditoPadreID)) {
            ...
            transaction.begin(function (err) {
              ...
              request.query("update TipoCredito set nombre = '" + nombre + "', descripcion = '" + descripcion + "', tipoCreditoPadreID = " + tipoCreditoPadreID + " where ID = " + _this2.props.tipoCredito.ID, function (err, result) {
                if (err) {
                  if (!rolledBack) {
                    console.log(err);
                  ...
                  transaction.commit(function (err) {
                    _this2.showSuccesMessage("Exito", "Tipo de crédito modificado con éxito.");
    ...
    value: function eliminarTipoCredito() {
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("delete from TipoCredito where ID = " + _this3.props.tipoCredito.ID, function (err, result) {
          if (err) {
            if (!rolledBack) {
              console.log(err);
              transaction.rollback(function (err) {});
            ...
            transaction.commit(function (err) {
              _this3.showSuccesMessage("Exito", "Tipo de crédito eliminado con éxito.");
              ...
              }, _this3.props.retornoSelCreditos);

              _this3.props.loadTypeCredit();
            });
          }
        });
      }); // fin transaction
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", null, _react["default"].createElement("div", {
        ...
        "aria-current": "page"
      }, "Editar Tipo de Cr\xE9dito"))))))), _react["default"].createElement("div", {
        className: "row"
      }, _react["default"].createElement("div", {
        ...
        type: "text",
        defaultValue: this.props.tipoCredito.nombre,
        ...
        className: "form-control",
        defaultValue: this.props.tipoCredito.descripcion
      }))))), _react["default"].createElement("div", {
        className: "col-xl-12 col-12"
      }, _react["default"].createElement("div", {
        className: "card"
        ...
        defaultValue: this.props.tipoCredito.tipoCreditoPadreID
      ...
      }, "Guardar"), !this.props.tipoCredito.tipoCreditoPadreID != -1 ? _react["default"].createElement("a", {
        onClick: function onClick() {
          return _this4.props.seleccionarCredito(_this4.props.tipoCredito.ID, _this4.props.tipoCredito.nombre);
        },
      ...
      }, "Configurar Variables") : _react["default"].createElement("span", null)), _react["default"].createElement("br", null), _react["default"].createElement("div", {
        className: "text-center"
      }, _react["default"].createElement("a", {
  ...
  return EditarTipoCredito;
}(_react["default"].Component);

exports["default"] = EditarTipoCredito;
//# sourceMappingURL=EditarTipoCredito.js.map
