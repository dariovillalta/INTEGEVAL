...
var CrearCategoriaClasificacion =
/*#__PURE__*/
function (_React$Component) {
  _inherits(CrearCategoriaClasificacion, _React$Component);

  function CrearCategoriaClasificacion(props) {
    var _this;

    _classCallCheck(this, CrearCategoriaClasificacion);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CrearCategoriaClasificacion).call(this, props));
    _this.state = {
  ...
  return CrearCategoriaClasificacion;
}(_react["default"].Component);

exports["default"] = CrearCategoriaClasificacion;
//# sourceMappingURL=CrearCategoriaClasificacion.js.map
