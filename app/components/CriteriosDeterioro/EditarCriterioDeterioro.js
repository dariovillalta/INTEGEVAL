...
var EditarCriterioDeterioro =
/*#__PURE__*/
function (_React$Component) {
  _inherits(EditarCriterioDeterioro, _React$Component);

  function EditarCriterioDeterioro(props) {
    var _this;

    _classCallCheck(this, EditarCriterioDeterioro);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EditarCriterioDeterioro).call(this, props));
    _this.state = {
    ...
    _this.eliminarCriterioDeterioro = _this.eliminarCriterioDeterioro.bind(_assertThisInitialized(_this));
  ...
  _createClass(EditarCriterioDeterioro, [{
    ...
    value: function iniciarCriterioDeterioro() {
      ...
      transaction.begin(function (err) {
        ...
        request.query("select * from CriterioDeterioro where categoriaClasPadre = " + idCategoria + " and tipoDeCredito = " + idTipoCredito, function (err, result) {
          if (err) {
            if (!rolledBack) {
              console.log(err);
    ...
    value: function guardarCriterioDeterioro(criterioDeterioroMismaCategoria) {
      ...
      var tipoCredito = this.state.tiposDeCredito[$("#tipoCreditoID").val()].ID;
                      ...
                      transaction.begin(function (err) {
                        ...
                        request.query("update CriterioDeterioro set categoriaClasPadre = " + categoriaClasificacion + ", nombreClasPadre = '" + nombreClasPadre + "', categoria = '" + categoria + "', tipoDeCredito = " + tipoCredito + ", campoTipoGarantia = " + campoTipoGarantia + ", tipoGarantia = '" + tipoGarantia + "', inicioMora = " + inicioMora + ", finMora = " + finMora + ", estimacionDeterioro = " + porcentajeEstimacionDeterioro + " where ID = " + _this3.props.criterioDeterioro.ID, function (err, result) {
                          if (err) {
                            ...
                            transaction.commit(function (err) {
                              _this3.showSuccesMessage("Exito", "Criterio de Deterioro modificado con éxito.");
                            });
                          }
                        });
                      }); // fin transaction
    ...
    key: "traerAggararTiposCredito",
    value: function traerAggararTiposCredito() {
      var _this5 = this;
          ...
          if (err) {
            ...
            transaction.commit(function (err) {
              ...
              for (var i = result.recordset.length - 1; i >= 0; i--) {
                var existe = _this6.verificarExistencia(result.recordset[i].nombre, i, result.recordset);
    ...
    key: "eliminarCriterioDeterioro",
    value: function eliminarCriterioDeterioro() {
      var _this7 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("delete CriterioDeterioro where ID = " + _this7.props.criterioDeterioro.ID, function (err, result) {
          if (err) {
            if (!rolledBack) {
              console.log(err);
              transaction.rollback(function (err) {});
            ...
            transaction.commit(function (err) {
              _this7.showSuccesMessage("Exito", "Criterio de Deterioro eliminado con éxito.");

              _this7.props.returnSelCrit();
            });
          }
        });
      }); // fin transaction
    ...
    value: function render() {
      return _react["default"].createElement("div", null, _react["default"].createElement("div", {
        ...
        defaultValue: this.props.criterioDeterioro.categoriaClasPadre
        ...
        id: "tipoCreditoID",
        className: "form-control form-control-lg",
        defaultValue: this.props.criterioDeterioro.tipoDeCredito
        ...
        defaultValue: this.props.criterioDeterioro.campoTipoGarantia
        ...
        defaultValue: this.props.criterioDeterioro.tipoGarantia
      })))))), _react["default"].createElement("div", {
        className: "row"
      }, _react["default"].createElement("div", {
        ...
        defaultValue: this.props.criterioDeterioro.estimacionDeterioro
      }))))), _react["default"].createElement("div", {
        className: "col-sm-4 col-4"
      }, _react["default"].createElement("div", {
        className: "card"
        ...
        defaultValue: this.props.criterioDeterioro.inicioMora
      }))))), _react["default"].createElement("div", {
        className: "col-sm-4 col-4"
      }, _react["default"].createElement("div", {
        className: "card"
        ...
        defaultValue: this.props.criterioDeterioro.finMora
      })))))), _react["default"].createElement("div", {
        ...
        onClick: this.eliminarCriterioDeterioro,
        className: "btn btn-danger col-xs-6 col-6",
        style: {
          color: "white",
          fontSize: "1.2em",
          fontWeight: "bold"
  ...
  return EditarCriterioDeterioro;
}(_react["default"].Component);

exports["default"] = EditarCriterioDeterioro;
//# sourceMappingURL=EditarCriterioDeterioro.js.map
