...
function (_React$Component) {
  ...
  function EditarIndicador(props) {
    ...
    _this.getIndicator = _this.getIndicator.bind(_assertThisInitialized(_this));
    ...
    _this.traerElementosDeFormulaIndicador = _this.traerElementosDeFormulaIndicador.bind(_assertThisInitialized(_this));
    _this.editarIndicador = _this.editarIndicador.bind(_assertThisInitialized(_this));
    ...
    _this.retornoEditarIndicador = _this.retornoEditarIndicador.bind(_assertThisInitialized(_this));
  ...
  _createClass(EditarIndicador, [{
    ...
    value: function getIndicator() {
      ...
      transaction.begin(function (err) {
        ...
        request.query("select * from Indicadores where ID  = " + _this2.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                ...
                if (tipoValorIdealIndicador.localeCompare("porcentual") == 0) mostrarToleranciaPorcentaje = true;

                _this2.setState({
                  x: result.recordset[0].peso,
                  mostrarToleranciaPorcentaje: mostrarToleranciaPorcentaje,
                  periodicidadIndicador: periodicidadIndicador
                }, _this2.cargarDatePicker);
              }
            });
          }
        });
      ...
      transaction1.begin(function (err) {
        ...
        request.query("select * from IndicadoresCampos where indicadorID = " + _this2.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction1.commit(function (err) {
              if (result.recordset.length > 0) {
                ...
                for (var i = 0; i < result.recordset.length; i++) {
                  _this2.traerSegmentosDeCampo(result.recordset[i], i);

                  _this2.traerFormulasDeCampo(result.recordset[i], i);
                }
    ...
    value: function traerSegmentosDeCampo(campo, posicionAtributo) {
      var _this3 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from SegmentoReglasIndicadores where indicadorID = " + _this3.props.idIndicadorSeleccionado + " and indicadorCampoID = " + campo.ID, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                if (segmentoRegla[posicionAtributo] == null) segmentoRegla[posicionAtributo] = [];
                segmentoRegla[posicionAtributo] = result.recordset;

                for (var i = 0; i < segmentoRegla[posicionAtributo].length; i++) {
                  _this3.traerReglasDeCampo(campo, segmentoRegla[posicionAtributo][i], posicionAtributo, i);
                }
    ...
    value: function traerReglasDeCampo(campo, segmento, posicionAtributo, posicionSegmento) {
      var _this4 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from ReglasIndicadores where indicadorID = " + _this4.props.idIndicadorSeleccionado + " and indicadorCampoID = " + campo.ID + " and segmentoReglaID = " + segmento.ID, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                ...
                if (reglas[posicionAtributo] == null) reglas[posicionAtributo] = [];
                if (reglas[posicionAtributo][posicionSegmento] == null) reglas[posicionAtributo][posicionSegmento] = [];
    ...
    value: function traerFormulasDeCampo(campo, posicionAtributo) {
      var _this5 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from FormulasIndicadoresCampos where indicadorID = " + _this5.props.idIndicadorSeleccionado + " and indicadorCampoID = " + campo.ID, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                if (formulas[posicionAtributo] == null) formulas[posicionAtributo] = [];
                formulas[posicionAtributo] = result.recordset;

                for (var i = 0; i < formulas[posicionAtributo].length; i++) {
                  _this5.traerElementosDeCampo(campo, formulas[posicionAtributo][i], posicionAtributo, i);
                }
    ...
    value: function traerElementosDeCampo(campo, formula, posicionAtributo, posicionFormula) {
      var _this6 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from ElementoFormulasIndicadoresCampos where indicadorID = " + _this6.props.idIndicadorSeleccionado + " and indicadorCampoID = " + campo.ID + " and formulaID = " + formula.ID, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                if (elementosFormulas[posicionAtributo] == null) elementosFormulas[posicionAtributo] = [];
                if (elementosFormulas[posicionAtributo][posicionFormula] == null) elementosFormulas[posicionAtributo][posicionFormula] = [];
    ...
    key: "traerElementosDeFormulaIndicador",
    value: function traerElementosDeFormulaIndicador() {
      var _this7 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from ElementoIndicador where indicadorID = " + _this7.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
    ...
    key: "editarIndicador",
    value: function editarIndicador() {
      var _this8 = this;
      ...
      transaction1.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction1);
        request.query("DELETE FROM ElementoIndicador WHERE indicadorID = " + _this8.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
      ...
      transaction2.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction2);
        request.query("DELETE FROM IndicadoresCampos WHERE indicadorID = " + _this8.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
      ...
      transaction3.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction3);
        request.query("DELETE FROM FormulasIndicadoresCampos WHERE indicadorID = " + _this8.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
      ...
      transaction4.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction4);
        request.query("DELETE FROM ElementoFormulasIndicadoresCampos WHERE indicadorID = " + _this8.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
      ...
      transaction5.begin(function (err) {
        ...
        request.query("DELETE FROM SegmentoReglasIndicadores WHERE indicadorID = " + _this8.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
      ...
      transaction6.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction6);
        request.query("DELETE FROM ReglasIndicadores WHERE indicadorID = " + _this8.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
                            ...
                            if (!isNaN(parseInt(riesgoPadre))) {
                              if (this.isValidDate(fecha)) {
                                ...
                                transaction.begin(function (err) {
                                  ...
                                  var request = new _mssql["default"].Request(transaction);
                                  request.query("update Indicadores set nombre = '" + nombre + "', codigo = '" + codigo + "', formula = '" + formula + "', peso = " + peso + ", tolerancia = " + tolerancia + ", valorIdeal = " + valorIdeal + ", tipoValorIdeal = '" + tipoValorIdeal + "', periodicidad = '" + periodicidad + "', tipoIndicador = '" + tipoIndicador + "', responsable = '" + responsable + "', idRiesgoPadre = " + riesgoPadre + ", fechaInicioCalculo = '" + fecha.getFullYear() + "-" + (fecha.getMonth() + 1) + "-" + fecha.getDate() + "' WHERE ID = " + _this8.props.idIndicadorSeleccionado, function (err, result) {
                                    if (err) {
                                      console.log(err);
                                      ...
                                      transaction.commit(function (err) {
                                        ...
                                        contadorObjetosAGuardar = 0;
                                        var indicador = {
                                          ID: _this8.props.idIndicadorSeleccionado,
                                          nombre: nombre
                                        };

                                        if (elementosFormulasG.length != 0) {
                                          for (var i = 0; i < elementosFormulasG.length; i++) {
                                            _this8.createIndicatorFormulaElements(indicador, elementosFormulasG[i], i, elementosFormulasG.length - 1);
                                          }
                                          ...
                                          for (var i = 0; i < atributos.length; i++) {
                                            ...
                                            _this8.createIndicatorField(atributos[i], i);
                                          }
            ...
            transaction.commit(function (err) {
              if (indiceElemento == ultimaPosicionElemento && atributos.length > 0) {
                for (var i = 0; i < atributos.length; i++) {
                  ...
                  _this9.createIndicatorField(atributos[i], i);
                }
    ...
    value: function createIndicatorField(indicadorCampo, posicionAtributo) {
      var _this10 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("insert into IndicadoresCampos (indicadorID, nombre, tipo, nivel) values (" + _this10.props.idIndicadorSeleccionado + ", '" + indicadorCampo.nombre + "', '" + indicadorCampo.tipo + "', " + indicadorCampo.nivel + ")", function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              ...
              _this10.getIndicatorFieldID(indicadorCampo, posicionAtributo);
            });
          }
        });
      }); // fin transaction
    ...
    value: function getIndicatorFieldID(indicadorCampo, posicionAtributo) {
      var _this11 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from IndicadoresCampos where nombre = '" + indicadorCampo.nombre + "' and indicadorID = " + _this11.props.idIndicadorSeleccionado, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              ...
              for (var j = 0; j < formulas[posicionAtributo].length; j++) {
                ...
                _this11.createVariableFieldFormula(result.recordset[0], formulas[posicionAtributo][j], posicionAtributo, j, arregloDeFormulasALlamar, arregloElementosDeFormulasALlamar);
              }
              ...
              if (formulas[posicionAtributo].length == 0) {
                ...
                for (var j = 0; j < segmentoRegla[posicionAtributo].length; j++) {
                  ...
                  _this11.createVariableFieldRuleSegments(result.recordset[0], segmentoRegla[posicionAtributo][j], posicionAtributo, j, arregloDeSegmentosALlamar, arregloReglasDeSegmentosALlamar);
                }
    ...
    value: function createVariableFieldRuleSegments(indicadorCampo, segmento, posicionAtributo, posicionSegmento, arregloDeSegmentosALlamar, arregloReglasDeSegmentosALlamar) {
      var _this12 = this;
        ...
        request.query("insert into SegmentoReglasIndicadores (conexionTablaID, indicadorID, indicadorCampoID, variableIDCreacionCodigo, excelArchivoID, excelVariableID, formaVariableID, esValorManual, esConexionTabla, posicionSegmentoEnCampo, nivelMax) values (" + segmento.conexionTablaID + ", " + _this12.props.idIndicadorSeleccionado + ", " + indicadorCampo.ID + ", " + segmento.variableID + ", " + segmento.excelArchivoID + ", " + segmento.excelVariableID + ", " + segmento.formaVariableID + ", '" + segmento.esValorManual + "', '" + segmento.esConexionTabla + "', " + posicionSegmento + ", " + segmento.nivelMax + ")", function (err, result) {
          if (err) {
            ...
            transaction.commit(function (err) {
              ...
              _this12.getVariableFieldRuleSegments(indicadorCampo, segmento, posicionAtributo, posicionSegmento, arregloDeSegmentosALlamar, arregloReglasDeSegmentosALlamar);
            });
          }
        });
      }); // fin transaction
    ...
    value: function getVariableFieldRuleSegments(indicadorCampo, segmento, posicionAtributo, posicionSegmento, arregloDeSegmentosALlamar, arregloReglasDeSegmentosALlamar) {
      var _this13 = this;
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                ...
                if (reglas[posicionAtributo][posicionSegmento][0].esCondicion) {
                  ...
                  _this13.createVariableFieldRules(indicadorCampo, result.recordset[0], reglas[posicionAtributo][posicionSegmento][0], posicionAtributo, posicionSegmento, 0, arregloReglasDeSegmentosALlamar, -1);
    ...
    value: function createVariableFieldRules(indicadorCampo, segmento, regla, posicionAtributo, posicionSegmento, posicionRegla, arregloReglasDeSegmentosALlamar, reglaPadreID) {
      var _this14 = this;
            ...
            if (err) {
              ...
              transaction.commit(function (err) {
                ...
                if (arregloReglasDeSegmentosALlamar.length == 0) {
                  ...
                  _this14.traerRegla(indicadorCampo, segmento, regla, posicionAtributo, posicionSegmento, posicionRegla, arregloReglasDeSegmentosALlamar, reglaPadreID);
                }
              });
            }
          });
    ...
    key: "traerRegla",
    value: function traerRegla(indicadorCampo, segmento, regla, posicionAtributo, posicionSegmento, posicionRegla, arregloReglasDeSegmentosALlamar, reglaPadreID) {
      var _this15 = this;
              ...
              if (result.recordset.length > 0) {
                ...
                if (reglas[posicionAtributo] != undefined && reglas[posicionAtributo][posicionSegmento] != undefined && reglas[posicionAtributo][posicionSegmento][posicionRegla + 1] != undefined) {
                  if (reglas[posicionAtributo][posicionSegmento][posicionRegla + 1].esCondicion) {
                    ...
                    _this15.createVariableFieldRules(indicadorCampo, segmento, reglas[posicionAtributo][posicionSegmento][posicionRegla + 1], posicionAtributo, posicionSegmento, posicionRegla + 1, arregloReglasDeSegmentosALlamar, result.recordset[0].ID);
    ...
    value: function createVariableFieldFormula(indicadorCampo, formula, posicionAtributo, posicionFormula, arregloDeFormulasALlamar, arregloElementosDeFormulasALlamar) {
      var _this16 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("insert into FormulasIndicadoresCampos (indicadorID, indicadorCampoID, posicionFormulaEnCampo, formula, operacion) values (" + _this16.props.idIndicadorSeleccionado + ", " + indicadorCampo.ID + ", " + posicionFormula + ", '" + formula.formula + "', '" + formula.operacion + "')", function (err, result) {
          if (err) {
            console.log(err);
            contadorObjetosGuardados++;
            ...
            transaction.commit(function (err) {
              ...
              _this16.getVariableFieldFormulaID(indicadorCampo, formula, posicionAtributo, posicionFormula, arregloDeFormulasALlamar, arregloElementosDeFormulasALlamar);
            });
          }
        });
      }); // fin transaction
    ...
    value: function getVariableFieldFormulaID(indicadorCampo, formula, posicionAtributo, posicionFormula, arregloDeFormulasALlamar, arregloElementosDeFormulasALlamar) {
      var _this17 = this;
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from FormulasIndicadoresCampos where indicadorID = " + _this17.props.idIndicadorSeleccionado + " and indicadorCampoID = " + indicadorCampo.ID + " and posicionFormulaEnCampo = " + posicionFormula, function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                ...
                for (var i = 0; i < elementosFormulas[posicionAtributo][posicionFormula].length; i++) {
                  ...
                  _this17.createVariableFieldFormulaElement(indicadorCampo, result.recordset[0], elementosFormulas[posicionAtributo][posicionFormula][i], posicionAtributo, posicionFormula, i, arregloElementosDeFormulasALlamar, existenSegmentos);
                }
                ...
                if (posicionFormula == 0) {
                  ...
                  for (var j = 0; j < segmentoRegla[posicionAtributo].length; j++) {
                    ...
                    _this17.createVariableFieldRuleSegments(indicadorCampo, segmentoRegla[posicionAtributo][j], posicionAtributo, j, arregloDeSegmentosALlamar, arregloReglasDeSegmentosALlamar);
                  }
    ...
    value: function createVariableFieldFormulaElement(indicadorCampo, formula, elemento, posicionAtributo, posicionFormula, posicionElemento, arregloElementosDeFormulasALlamar, existenSegmentos) {
      var _this18 = this;
    ...
    value: function goToCreateFormula() {
      var navbar = _react["default"].createElement("div", {
        ...
        href: "#",
        className: "breadcrumb-link"
      }, "Seleccionar Indicador")), _react["default"].createElement("li", {
        className: "breadcrumb-item font-16",
        "aria-current": "page",
        onClick: this.retornoEditarIndicador
      }, _react["default"].createElement("a", {
        href: "#",
        className: "breadcrumb-link"
      }, "Modificar Indicador")), _react["default"].createElement("li", {
    ...
    key: "retornoEditarIndicador",
    value: function retornoEditarIndicador() {
      this.setState({
        componenteActual: "editarIndicador"
    ...
    value: function goCrearUmbral() {
      var navbar = _react["default"].createElement("div", {
        ...
        href: "#",
        className: "breadcrumb-link"
      }, "Editar Indicador")), _react["default"].createElement("li", {
        className: "breadcrumb-item active font-16",
        "aria-current": "page"
      }, "Umbrales")))))));
    ...
    value: function verificarSiExisteExcelEnResultadosHistoricosModificar(variable) {
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("select * from ResultadosNombreIndicadores where nombreIndicador = '" + variable.nombre + "' and finVigencia = '1964-05-28'", function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              if (result.recordset.length == 0) {
                _this19.crearTablaDeResultadoNombreModificar(variable);
              } else {
                _this19.modificarResultadosNombre(variable, result.recordset[0].inicioVigencia);
              }
            });
          }
        });
      ...
      transaction.begin(function (err) {
        ...
        request.query(textoCreacionTabla, function (err, result) {
          if (err) {
            ...
            transaction.commit(function (err) {
              _this20.crearResultadoNombreModificar(variable, hoy);
            });
          }
        });
      }); // fin transaction
    ...
    value: function crearResultadoNombreModificar(variable, hoy) {
      ...
      transaction.begin(function (err) {
        ...
        var request = new _mssql["default"].Request(transaction);
        request.query("insert into ResultadosNombreIndicadores (nombreIndicador, inicioVigencia, finVigencia) values ('" + variable.nombre + "', '" + hoy.getFullYear() + '-' + mes + '-' + dia + " " + hoy.getHours() + ":" + hoy.getMinutes() + ":" + hoy.getSeconds() + "', '1964-05-28')", function (err, result) {
          if (err) {
            console.log(err);
            ...
            transaction.commit(function (err) {
              _this21.verificarPeriodicidadGuardarModificar(variable, "indicador", hoy);
            });
          }
        });
      }); // fin transaction
      ...
      transaction.begin(function (err) {
        ...
        request.query("update ResultadosNombreVariables set finVigencia = '" + hoy.getFullYear() + '-' + mes + '-' + dia + " " + hoy.getHours() + "' where ID = " + resultado.ID, function (err, result) {
          if (err) {
            ...
            transaction.commit(function (err) {
              _this22.crearTablaDeResultadoNombreModificar(variable);
            });
          }
        });
      }); // fin transaction
      ...
      transaction.begin(function (err) {
        ...
        request.query("select * from PeriodicidadCalculo where variableID = " + variable.ID + " and tablaVariable = '" + tabla + "'", function (err, result) {
          if (err) {
            ...
            transaction.commit(function (err) {
              if (result.recordset.length > 0) {
                _this23.updatePeriodicidadModificar(variable, tabla, hoy);
              }
              /* else {
    ...
    value: function render() {
      ...
      if (this.state.componenteActual.localeCompare("editarIndicador") == 0) {
        return _react["default"].createElement("div", null, _react["default"].createElement("div", {
          ...
          className: "breadcrumb-item active font-16",
          "aria-current": "page"
        }, "Modificar Indicador"))))))), _react["default"].createElement("div", {
          className: "row"
        }, _react["default"].createElement("div", {
          className: "col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
        }, _react["default"].createElement("div", {
        ...
        }, "Editar F\xF3rmula"))), _react["default"].createElement("br", null), _react["default"].createElement("hr", null), _react["default"].createElement("div", {
          className: "row"
        }, _react["default"].createElement("div", {
          className: "col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
        }, _react["default"].createElement("div", {
          ...
          onClick: function onClick() {
            return _this25.goToCreateConditions(-1);
          }
          ...
          return _react["default"].createElement("div", {
            ...
            onClick: function onClick() {
              return _this25.goToCreateConditions(i);
            }
          }, "Editar Instrucci\xF3n Personalizada "), _react["default"].createElement("br", null));
        }))), _react["default"].createElement("br", null), _react["default"].createElement("hr", null), _react["default"].createElement("a", {
          ...
          onClick: this.editarIndicador
        }, "Modificar Indicador")), _react["default"].createElement("br", null)))))));
        ...
        return _react["default"].createElement("div", null, _react["default"].createElement(_Umbral["default"], {
          navbar: this.state.navbar,
          idVariable: this.props.idIndicadorSeleccionado,
          pool: this.props.pool,
