...
function (_React$Component) {
  _inherits(FilterValor, _React$Component);

  function FilterValor(props) {
    var _this;

    _classCallCheck(this, FilterValor);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FilterValor).call(this, props));
    _this.state = {
      listas: [],
      variablesDeLista: []
    };
  ...
  _createClass(FilterValor, [{
    ...
    value: function render() {
      if (this.props.esNumero) {
        ...
        }, _react["default"].createElement("h3", null, "Seleccionar Campo"), _react["default"].createElement("div", null, _react["default"].createElement("div", {
        ...
        }), _react["default"].createElement("h4", null, "Seleccionar Elementos"), _react["default"].createElement("div", null, _react["default"].createElement("div", {
          className: "form-group"
        }, _react["default"].createElement("select", {
          id: "camposDeLista",
          className: "form-control form-control-lg",
        ...
        return _react["default"].createElement("div", {
          ...
          className: "col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
        }, _react["default"].createElement("h3", null, "Seleccionar Operacion"), _react["default"].createElement("div", null, _react["default"].createElement("div", {
        ...
        return _react["default"].createElement("div", {
          ...
          className: "col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
        }, _react["default"].createElement("h3", null, "Seleccionar Campo"), _react["default"].createElement("div", {
          className: "form-group"
        }, _react["default"].createElement("select", {
          id: "selectLista",
          className: "form-control form-control-lg",
        ...
        }), _react["default"].createElement("h4", null, "Seleccionar Elementos"), _react["default"].createElement("div", {
          className: "form-group"
        }, _react["default"].createElement("select", {
          id: "camposDeLista",
          className: "form-control form-control-lg",
...
exports["default"] = FilterValor;
//# sourceMappingURL=FilterValor.js.map
