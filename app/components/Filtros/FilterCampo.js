...
function (_React$Component) {
  _inherits(FilterCampo, _React$Component);

  function FilterCampo(props) {
    var _this;

    _classCallCheck(this, FilterCampo);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FilterCampo).call(this, props));
    _this.checkFieldType = _this.checkFieldType.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(FilterCampo, [{
    key: "checkFieldType",
    ...
    value: function render() {
      ...
      }, this.props.campos.map(function (campo, i) {
...
exports["default"] = FilterCampo;
//# sourceMappingURL=FilterCampo.js.map
