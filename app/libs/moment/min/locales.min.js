...
!function (a, b) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module && "function" == typeof require ? b(require("../moment")) : "function" == typeof define && define.amd ? define(["moment"], b) : b(a.moment);
}(void 0, function (a) {
  ...
  function V(a) {
    var b = Math.floor(a % 1e3 / 100),
        ...
        d = a % 10,
        e = "";
    return b > 0 && (e += cb[b] + "vatlh"), c > 0 && (e += ("" !== e ? " " : "") + cb[c] + "maH"), d > 0 && (e += ("" !== e ? " " : "") + cb[d]), "" === e ? "pagh" : e;
  }
  ...
  var _ = (a.defineLocale("af", {
    ...
    translate: function translate(a, b, c) {
      var d = Ka.words[c];
      return 1 === c.length ? b ? d[0] : d[1] : a + " " + Ka.correctGrammaticalCase(a, d);
    }
  }),
      La = (a.defineLocale("me", {
    ...
    week: {
      ...
      Wa = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_"),
      Xa = (a.defineLocale("pl", {
    months: function months(a, b) {
      return "" === b ? "(" + Wa[a.month()] + "|" + Va[a.month()] + ")" : /D MMMM/.test(b) ? Wa[a.month()] : Va[a.month()];
    },
    ...
    translate: function translate(a, b, c) {
      var d = _a.words[c];
      return 1 === c.length ? b ? d[0] : d[1] : a + " " + _a.correctGrammaticalCase(a, d);
    }
  }),
      ab = (a.defineLocale("sr", {
    months: "januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar".split("_"),
    monthsShort: "jan._feb._mar._apr._maj_jun_jul_avg._sep._okt._nov._dec.".split("_"),
    monthsParseExact: !0,
