...
!function (t, e) {
  ...
  function e(t) {
    ...
    e.loadConfig(t), e.beforeInit(t), e.init(), e.afterInit(t), function e(i, n, a) {
      Object.keys(i).forEach(function (t) {
        n[t] = i[t].bind(a), 0 < Object.keys(i[t]).length && e(i[t], n[t], a);
      });
  ...
  var r,
    ...
    return t[1] - t[0];
      ...
      g = function g(t) {
    return null == t || c(t) && 0 === t.length || "object" === (void 0 === t ? "undefined" : o(t)) && 0 === Object.keys(t).length;
  },
      C = function C(t) {
  ...
  (s = p.prototype).axisX = function (t, e, i) {
    ...
    return t.select("text").text(function (t) {
      ...
      n && a && (s.h = n, s.w = a);
    }).text(""), r.tickTextCharSize = s;
  }, s.isVertical = function () {
    return "left" === this.orient || "right" === this.orient;
  }, s.tspanData = function (t, e, i) {
    var n = this,
        a = n.params.tickMultiline ? n.splitTickText(t, i) : [].concat(n.textFormatted(t));
    return n.params.tickMultiline && 0 < n.params.tickMultilineMax && (a = n.ellipsify(a, n.params.tickMultilineMax)), a.map(function (t) {
      return {
        index: e,
        splitted: t,
        length: a.length
    ...
    return (!c || c <= 0) && (c = o.isVertical() ? 95 : o.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110), function t(e, i) {
      r = void 0;

      for (var n = 1; n < i.length; n++) {
        if (" " === i.charAt(n) && (r = n), a = i.substr(0, n + 1), s = o.tickTextCharSize.w * a.length, c < s) return t(e.concat(i.substr(0, r || n)), i.slice(r ? r + 1 : n));
      }
    ...
    for (var i = t.slice(0, e), n = 3, a = e - 1; 0 <= a; a--) {
      var r = i[a].length;
      if (i[a] = i[a].substr(0, r - n).padEnd(r, "."), (n -= r) <= 0) break;
    }
    ...
    function A(t, m) {
      ...
      return t.each(function () {
        var t,
            ...
            s = w.tickValues ? w.tickValues : w.generateTicks(r),
            o = n.selectAll(".tick").data(s, r),
            c = o.enter().insert("g", ".domain").attr("class", "tick").style("opacity", 1e-6),
            d = o.exit().remove(),
            u = o.merge(c);
        b.isCategory ? (w.tickOffset = Math.ceil((r(1) - r(0)) / 2), e = w.tickCentered ? 0 : w.tickOffset, i = w.tickCentered ? w.tickOffset : 0) : w.tickOffset = e = 0, w.updateRange(), w.updateTickLength(), w.updateTickTextCharSize(n.select(".tick"));
        var l = u.select("line").merge(c.append("line")),
            h = u.select("text").merge(c.append("text")),
            g = u.selectAll("text").selectAll("tspan").data(function (t, e) {
          return w.tspanData(t, e, r);
        }),
            f = g.enter().append("tspan").merge(g).text(function (t) {
          return t.splitted;
        });
        g.exit().remove();

        var p = n.selectAll(".domain").data([0]),
            _ = p.enter().append("path").merge(p).attr("class", "domain");

        switch (w.orient) {
          case "bottom":
            t = w.axisX, l.attr("x1", e).attr("x2", e).attr("y2", function (t, e) {
              return w.lineY2(t, e);
          ...
          case "left":
            t = w.axisY, l.attr("x2", -w.innerTickSize).attr("y1", i).attr("y2", i), h.attr("x", -w.tickLength).attr("y", w.tickOffset).style("text-anchor", "end"), f.attr("x", -w.tickLength).attr("dy", function (t, e) {
              return w.tspanDy(t, e);
            }), _.attr("d", "M" + -w.outerTickSize + "," + w.range[0] + "H0V" + w.range[1] + "H" + -w.outerTickSize);
            break;

          case "right":
            t = w.axisY, l.attr("x2", w.innerTickSize).attr("y1", i).attr("y2", i), h.attr("x", w.tickLength).attr("y", w.tickOffset).style("text-anchor", "start"), f.attr("x", w.tickLength).attr("dy", function (t, e) {
              return w.tspanDy(t, e);
            }), _.attr("d", "M" + w.outerTickSize + "," + w.range[0] + "H0V" + w.range[1] + "H" + w.outerTickSize);
        }
        ...
        c.call(t, a, w.tickOffset), S = (m ? u.transition(m) : u).style("opacity", 1).call(t, r, w.tickOffset);
      }), S;
    }
  ...
  var x,
    ...
    function n(t) {
      ...
      }(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, t, "axis", e));
  ...
  return (r = S.prototype).init = function () {
    var t = this.owner,
        e = t.config,
        i = t.main;
    ...
    })), u.tickFormat(i).tickValues(n), o.isCategorized() && (u.tickCentered(c.axis_x_tick_centered), g(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)), u;
    ...
    return i.axis_x_tick_format && (h(i.axis_x_tick_format) ? n = i.axis_x_tick_format : e.isTimeSeries() && (n = function n(t) {
    ...
    return P(a) ? "ratio" === t.unit ? t[e] * n : this.convertPixelsToAxisPadding(a, n) : i;
    ...
    var n,
        ...
        d,
        u = t;
    if (e) if (1 === (n = h(e) ? e() : e)) u = [t[0]];else if (2 === n) u = [t[0], t[t.length - 1]];else if (2 < n) {
      for (s = n - 2, a = t[0], o = ((r = t[t.length - 1]) - a) / (s + 1), u = [a], c = 0; c < s; c++) {
        d = +a + o * (c + 1), u.push(i ? new Date(d) : d);
      }

      u.push(r);
    }
    return i || (u = u.sort(function (t, e) {
      return t - e;
    })), u;
  ...
  }, x = n.chart.fn, (m = n.chart.internal.fn).beforeInit = function () {}, m.afterInit = function () {}, m.init = function () {
    var t = this,
        e = t.config;
    ...
    p = I.generateDrawArea ? I.generateDrawArea(F, !1) : void 0, _ = I.generateDrawBar ? I.generateDrawBar(X) : void 0, x = I.generateDrawLine ? I.generateDrawLine(M, !1) : void 0, y = I.generateXYForText(F, X, M, !0), m = I.generateXYForText(F, X, M, !1), I.updateCircleY(), E = (I.config.axis_rotated ? I.circleY : I.circleX).bind(I), O = (I.config.axis_rotated ? I.circleX : I.circleY).bind(I), i && (I.subY.domain(I.getYDomain(H, "y")), I.subY2.domain(I.getYDomain(H, "y2"))), I.updateXgridFocus(), R.select("text." + Y.text + "." + Y.empty).attr("x", I.width / 2).attr("y", I.height / 2).text(D.data_empty_label_text).transition().style("opacity", H.length ? 0 : 1), h && I.redrawEventRect(), I.updateGrid(S), I.updateRegion(S), I.updateBar(w), I.updateLine(w), I.updateArea(w), I.updateCircle(E, O), I.hasDataLabel() && I.updateText(y, m, w), I.redrawTitle && I.redrawTitle(), I.redrawArc && I.redrawArc(S, w, o), I.redrawSubchart && I.redrawSubchart(n, e, S, w, F, X, M), R.selectAll("." + Y.selectedCircles).filter(I.isBarType.bind(I)).selectAll("circle").remove(), t.flow && (T = I.generateFlow({
      ...
      xForText: y,
      yForText: m
    })), I.isTabVisible() && (S ? (P = k.transition().duration(S), b = [], [I.redrawBar(_, !0, P), I.redrawLine(x, !0, P), I.redrawArea(p, !0, P), I.redrawCircle(E, O, !0, P), I.redrawText(y, m, t.flow, !0, P), I.redrawRegion(!0, P), I.redrawGrid(!0, P)].forEach(function (t) {
      t.forEach(function (t) {
        b.push(t);
      });
    }), A = I.generateWait(), b.forEach(function (t) {
      A.add(t);
    }), A(function () {
      T && T(), D.onrendered && D.onrendered.call(I);
    })) : (I.redrawBar(_), I.redrawLine(x), I.redrawArea(p), I.redrawCircle(E, O), I.redrawText(y, m, t.flow), I.redrawRegion(), I.redrawGrid(), T && T(), D.onrendered && D.onrendered.call(I))), I.mapToIds(I.data.targets).forEach(function (t) {
      I.withoutFadeIn[t] = !0;
    });
    ...
    var e,
        ...
        n = this,
        a = n.config;
    return "main" === t ? (e = l(n.margin.left), i = l(n.margin.top)) : "context" === t ? (e = l(n.margin2.left), i = l(n.margin2.top)) : "legend" === t ? (e = n.margin3.left, i = n.margin3.top) : "x" === t ? (e = 0, i = a.axis_rotated ? 0 : n.height) : "y" === t ? (e = 0, i = a.axis_rotated ? n.height : 0) : "y2" === t ? (e = a.axis_rotated ? 0 : n.width, i = a.axis_rotated ? 1 : 0) : "subx" === t ? (e = 0, i = a.axis_rotated ? 0 : n.height2) : "arc" === t && (e = n.arcWidth / 2, i = n.arcHeight / 2 - (n.hasType("gauge") ? 6 : 0)), "translate(" + e + "," + i + ")";
    ...
    var i,
        ...
        a,
        r = this;
    e && e.axisX ? i = e.axisX : (i = r.main.select("." + Y.axisX), t && (i = i.transition())), e && e.axisY ? n = e.axisY : (n = r.main.select("." + Y.axisY), t && (n = n.transition())), e && e.axisY2 ? a = e.axisY2 : (a = r.main.select("." + Y.axisY2), t && (a = a.transition())), (t ? r.main.transition() : r.main).attr("transform", r.getTranslate("main")), i.attr("transform", r.getTranslate("x")), n.attr("transform", r.getTranslate("y")), a.attr("transform", r.getTranslate("y2")), r.main.select("." + Y.chartArcs).attr("transform", r.getTranslate("arc"));
    ...
    var n = [],
      ...
      var i = setInterval(function () {
        ...
        }), e === n.length && (clearInterval(i), _t && _t());
      }, 50);
    };
    ...
    var e;
    return t instanceof Date ? e = t : "string" == typeof t ? e = this.dataTimeParse(t) : "object" === (void 0 === t ? "undefined" : o(t)) ? e = new Date(+t) : "number" != typeof t || isNaN(t) || (e = new Date(+t)), e && !isNaN(+e) || window.console.error("Failed to parse x '" + t + "' to Date object"), e;
  ...
  }, m.isValue = P, m.isFunction = h, m.isString = c, m.isUndefined = v, m.isDefined = k, m.ceil10 = d, m.asHalfPixel = l, m.diffDomain = D, m.isEmpty = g, m.notEmpty = C, m.notEmpty = C, m.getOption = N, m.hasValue = f, m.sanitise = _, m.getPathBox = y, m.CLASS = Y, Function.prototype.bind || (Function.prototype.bind = function (t) {
    ...
    i.prototype._isCurrentSpace = function () {
      ...
      if (this._skipOptionalSpaces(), this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, a = -1), !(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || "9" < this._string.charAt(this._currentIndex)) && "." != this._string.charAt(this._currentIndex))) {
        for (var o = this._currentIndex; this._currentIndex < this._endIndex && "0" <= this._string.charAt(this._currentIndex) && this._string.charAt(this._currentIndex) <= "9";) {
          this._currentIndex++;
        }

        if (this._currentIndex != o) for (var c = this._currentIndex - 1, d = 1; o <= c;) {
        ...
        if (this._currentIndex != s && this._currentIndex + 1 < this._endIndex && ("e" == this._string.charAt(this._currentIndex) || "E" == this._string.charAt(this._currentIndex)) && "x" != this._string.charAt(this._currentIndex + 1) && "m" != this._string.charAt(this._currentIndex + 1)) {
          if (this._currentIndex++, "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, r = -1), this._currentIndex >= this._endIndex || this._string.charAt(this._currentIndex) < "0" || "9" < this._string.charAt(this._currentIndex)) return;
  ...
  }), x.axis = function () {}, x.axis.labels = function (e) {
    var i = this.internal;
    ...
    "object" === (void 0 === t ? "undefined" : o(t)) ? (P(t.x) && (i.axis_x_max = t.x), P(t.y) && (i.axis_y_max = t.y), P(t.y2) && (i.axis_y2_max = t.y2)) : i.axis_y_max = i.axis_y2_max = t, e.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    });
    ...
    "object" === (void 0 === t ? "undefined" : o(t)) ? (P(t.x) && (i.axis_x_min = t.x), P(t.y) && (i.axis_y_min = t.y), P(t.y2) && (i.axis_y2_min = t.y2)) : i.axis_y_min = i.axis_y2_min = t, e.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    });
    ...
    var e = this.internal;
    if (window.clearInterval(e.intervalForObserveInserted), void 0 !== e.resizeTimeout && window.clearTimeout(e.resizeTimeout), window.detachEvent) window.detachEvent("onresize", e.resizeIfElementDisplayed);else if (window.removeEventListener) window.removeEventListener("resize", e.resizeIfElementDisplayed);else {
    ...
    var a,
        ...
        l = 0,
        h = 0;
    if (t.json) e = c.convertJsonToData(t.json, t.keys);else if (t.rows) e = c.convertRowsToData(t.rows);else {
      if (!t.columns) return;
      e = c.convertColumnsToData(t.columns);
    }
    a = c.convertDataToTargets(e, !0), c.data.targets.forEach(function (t) {
      var e,
          i,
          n = !1;
      ...
      for (e = 0; e < a.length; e++) {
        if (t.id === a[e].id) {
          for (n = !0, t.values[t.values.length - 1] && (h = t.values[t.values.length - 1].index + 1), l = a[e].values.length, i = 0; i < l; i++) {
            a[e].values[i].index = h + i, c.isTimeSeries() || (a[e].values[i].x = h + i);
          }

          t.values = t.values.concat(a[e].values), a.splice(e, 1);
          break;
        }
      }
      ...
      for (e = 0; e < d.length; e++) {
        if (t.id === d[e]) for (h = t.values[t.values.length - 1].index + 1, i = 0; i < l; i++) {
          t.values.push({
            id: t.id,
            index: h + i,
    ...
    }), c.data.targets.length && a.forEach(function (t) {
      var e,
          i = [];
    ...
    }), c.data.targets = c.data.targets.concat(a), c.getMaxDataCount(), r = (n = c.data.targets[0]).values[0], k(t.to) ? (l = 0, o = c.isTimeSeries() ? c.parseDate(t.to) : t.to, n.values.forEach(function (t) {
      t.x < o && l++;
    })) : k(t.length) && (l = t.length), u ? 1 === u && c.isTimeSeries() && (s = (n.values[n.values.length - 1].x - r.x) / 2, i = [new Date(+r.x - s), new Date(+r.x + s)], c.updateXDomain(null, !0, !0, !1, i)) : (s = c.isTimeSeries() ? 1 < n.values.length ? n.values[n.values.length - 1].x - r.x : r.x - c.getXDomain(c.data.targets)[0] : 1, i = [r.x - s, r.x], c.updateXDomain(null, !0, !0, !1, i)), c.updateTargets(c.data.targets), c.redraw({
      flow: {
        index: r.index,
        length: l,
    ...
    return function () {
      ...
      O.flowing = !0, O.data.targets.forEach(function (t) {
        t.values.splice(0, b);
      }), i = O.updateXDomain(l, !0, !0), O.updateXGrid && O.updateXGrid(!0), n = O.xgrid || R.selectAll([]), a = O.xgridLines || R.selectAll([]), r = O.mainRegion || R.selectAll([]), s = O.mainText || R.selectAll([]), o = O.mainBar || R.selectAll([]), c = O.mainLine || R.selectAll([]), d = O.mainArea || R.selectAll([]), u = O.mainCircle || R.selectAll([]), h.orgDataCount ? t = 1 === h.orgDataCount || (A && A.x) === (T && T.x) ? O.x(P[0]) - O.x(i[0]) : O.isTimeSeries() ? O.x(P[0]) - O.x(i[0]) : O.x(A.x) - O.x(T.x) : 1 !== O.data.targets[0].values.length ? t = O.x(P[0]) - O.x(i[0]) : O.isTimeSeries() ? (A = O.getValueOnIndex(O.data.targets[0].values, 0), T = O.getValueOnIndex(O.data.targets[0].values, O.data.targets[0].values.length - 1), t = O.x(A.x) - O.x(T.x)) : t = D(i) / 2, e = "translate(" + t + ",0) scale(" + D(P) / D(i) + ",1)", O.hideXGridFocus();
      var G = R.transition().ease(R.easeLinear).duration(C);
      V.add(O.xAxis(O.axes.x, G)), V.add(o.transition(G).attr("transform", e)), V.add(c.transition(G).attr("transform", e)), V.add(d.transition(G).attr("transform", e)), V.add(u.transition(G).attr("transform", e)), V.add(s.transition(G).attr("transform", e)), V.add(r.filter(O.isRegionOnX).transition(G).attr("transform", e)), V.add(n.transition(G).attr("transform", e)), V.add(a.transition(G).attr("transform", e)), V(function () {
        var t,
            e = [],
            i = [];
        ...
        if (b) {
          for (t = 0; t < b; t++) {
            e.push("." + Y.shape + "-" + (v + t)), i.push("." + Y.text + "-" + (v + t));
          }

          O.svg.selectAll("." + Y.shapes).selectAll(e).remove(), O.svg.selectAll("." + Y.texts).selectAll(i).remove(), O.svg.select("." + Y.xgrid).remove();
        }

        n.attr("transform", null).attr("x1", O.xgridAttr.x1).attr("x2", O.xgridAttr.x2).attr("y1", O.xgridAttr.y1).attr("y2", O.xgridAttr.y2).style("opacity", O.xgridAttr.opacity), a.attr("transform", null), a.select("line").attr("x1", I.axis_rotated ? 0 : y).attr("x2", I.axis_rotated ? O.width : y), a.select("text").attr("x", I.axis_rotated ? O.width : 0).attr("y", y), o.attr("transform", null).attr("d", g), c.attr("transform", null).attr("d", f), d.attr("transform", null).attr("d", p), u.attr("transform", null).attr("cx", _).attr("cy", x), s.attr("transform", null).attr("x", m).attr("y", S).style("fill-opacity", O.opacityForText.bind(O)), r.attr("transform", null), r.filter(O.isRegionOnX).attr("x", O.regionX.bind(O)).attr("width", O.regionWidth.bind(O)), L(), O.flowing = !1;
      });
    };
  }, x.focus = function (e) {
    var t,
  ...
  }, x.legend = function () {}, x.legend.show = function (t) {
    var e = this.internal;
    ...
    var t = this.internal,
        i = t.config;
    e.xs && t.addXs(e.xs), "names" in e && x.data.names.bind(this)(e.names), "classes" in e && Object.keys(e.classes).forEach(function (t) {
    ...
    var e,
        ...
        a = this.internal,
        r = a.config;
    return t = t || {}, e = a.getOption(t, "duration", r.transition_duration), i = a.getOption(t, "classes", [Y.region]), n = a.main.select("." + Y.regions).selectAll(i.map(function (t) {
      return "." + t;
    ...
    var l = this.internal,
        h = l.d3,
        g = l.config;
    g.data_selection_enabled && l.main.selectAll("." + Y.shapes).selectAll("." + Y.shape).each(function (t, e) {
      var i = h.select(this),
          n = t.data ? t.data.id : t.id,
          a = l.getToggle(this, t).bind(l),
          r = g.data_selection_grouped || !c || 0 <= c.indexOf(n),
          s = !d || 0 <= d.indexOf(e),
          o = i.classed(Y.SELECTED);
      i.classed(Y.line) || i.classed(Y.area) || (r && s ? g.data_selection_isselectable(t) && !o && a(!0, i.classed(Y.SELECTED, !0), t, e) : k(u) && u && o && a(!1, i.classed(Y.SELECTED, !1), t, e));
    });
  }, x.unselect = function (c, d) {
    var u = this.internal,
        l = u.d3,
        h = u.config;
    h.data_selection_enabled && u.main.selectAll("." + Y.shapes).selectAll("." + Y.shape).each(function (t, e) {
      var i = l.select(this),
          n = t.data ? t.data.id : t.id,
          a = u.getToggle(this, t).bind(u),
          r = h.data_selection_grouped || !c || 0 <= c.indexOf(n),
          s = !d || 0 <= d.indexOf(e),
          o = i.classed(Y.SELECTED);
      i.classed(Y.line) || i.classed(Y.area) || r && s && h.data_selection_isselectable(t) && o && a(!1, i.classed(Y.SELECTED, !1), t, e);
    });
  }, x.show = function (t, e) {
    var i,
        n = this.internal;
  ...
  }, x.tooltip = function () {}, x.tooltip.show = function (e) {
    var t,
        i,
        n = this.internal,
        a = {};
    e.mouse ? a = e.mouse : (e.data ? i = e.data : void 0 !== e.x && (t = e.id ? n.data.targets.filter(function (t) {
      return t.id === e.id;
    }) : n.data.targets, i = n.filterByX(t, e.x).slice(0, 1)[0]), a = i ? n.getMousePosition(i) : null), n.dispatchEvent("mousemove", a), n.config.tooltip_onshow.call(n, i);
    ...
    var t,
        ...
        o = !1,
        c = 0;
    return s ? (r.pie(r.filterTargetsToShow(r.data.targets)).forEach(function (t) {
      o || t.data.id !== e.data.id || (o = !0, (e = t).index = c), c++;
    }), isNaN(e.startAngle) && (e.startAngle = 0), isNaN(e.endAngle) && (e.endAngle = e.startAngle), r.isGaugeType(e.data) && (t = s.gauge_min, i = s.gauge_max, n = Math.PI * (s.gauge_fullCircle ? 2 : 1) / (i - t), a = e.value < t ? 0 : e.value < i ? e.value - t : i - t, e.startAngle = s.gauge_startingAngle, e.endAngle = e.startAngle + n * a), o ? e : null) : null;
  }, m.getSvgArc = function () {
    var n = this,
        e = n.hasType("gauge"),
        i = n.gaugeArcWidth / n.filterTargetsToShow(n.data.targets).length,
        a = n.d3.arc().outerRadius(function (t) {
      ...
      return e ? n.radius - i * (t.index + 1) : n.innerRadius;
        ...
        t = function t(_t2, e) {
      var i;
      return e ? a(_t2) : (i = n.updateAngle(_t2)) ? a(i) : "M 0 0";
    };
    ...
    var i = this,
        n = i.hasType("gauge"),
        a = i.gaugeArcWidth / i.filterTargetsToShow(i.data.targets).length,
        r = Math.min(i.radiusExpanded * e - i.radius, .8 * a - 100 * (1 - e)),
        s = i.d3.arc().outerRadius(function (t) {
      return n ? i.radius - a * t.index + r : i.radiusExpanded * e;
    }).innerRadius(function (t) {
    ...
    if (a = (n = d.selectAll("." + Y.arcs).selectAll("." + Y.arc).data(u.arcData.bind(u))).enter().append("path").attr("class", u.classArc.bind(u)).style("fill", function (t) {
      return u.color(t.data);
    }).style("cursor", function (t) {
      return c.interaction_enabled && c.data_selection_isselectable(t) ? "pointer" : null;
    }).each(function (t) {
      u.isGaugeType(t.data) && (t.startAngle = t.endAngle = c.gauge_startingAngle), this._current = t;
    }).merge(n), h && (o = (s = d.selectAll("." + Y.arcs).selectAll("." + Y.arcLabelLine).data(u.arcData.bind(u))).enter().append("rect").attr("class", function (t) {
      return Y.arcLabelLine + " " + Y.target + " " + Y.target + "-" + t.data.id;
    }).merge(s), 1 === u.filterTargetsToShow(u.data.targets).length ? o.style("display", "none") : o.style("fill", function (t) {
      return 0 < c.color_pattern.length ? u.levelColor(t.data.values[0].value) : u.color(t.data);
      ...
      if (u.hiddenTargetIds.indexOf(t.data.id) < 0) {
        var r = u.updateAngle(t),
            s = u.gaugeArcWidth / u.filterTargetsToShow(u.data.targets).length * (r.index + 1),
            o = r.endAngle - Math.PI / 2,
            c = u.radius - s,
            d = o - (0 === c ? 0 : 1 / c);
        e = u.radiusExpanded - u.radius + s, i = Math.cos(d) * c, n = Math.sin(d) * c, a = "rotate(" + 180 * o / Math.PI + ", " + i + ", " + n + ")";
      }

      l.select(this).attr("x", i).attr("y", n).attr("width", e).attr("height", 2).attr("transform", a).style("stroke-dasharray", "0, " + (e + 2) + ", 0");
    })), a.attr("transform", function (t) {
      return !u.isGaugeType(t.data) && i ? "scale(0)" : "";
    }).on("mouseover", c.interaction_enabled ? function (t) {
      var e, i;
      u.transiting || (e = u.updateAngle(t)) && (i = u.convertToArcData(e), u.expandArc(e.data.id), u.api.focus(e.data.id), u.toggleFocusLegend(e.data.id, !0), u.config.data_onmouseover(i, this));
    } : null).on("mousemove", c.interaction_enabled ? function (t) {
      var e,
          i = u.updateAngle(t);
      i && (e = [u.convertToArcData(i)], u.showTooltip(e, this));
    } : null).on("mouseout", c.interaction_enabled ? function (t) {
      var e, i;
      u.transiting || (e = u.updateAngle(t)) && (i = u.convertToArcData(e), u.unexpandArc(e.data.id), u.api.revert(), u.revertLegend(), u.hideTooltip(), u.config.data_onmouseout(i, this));
    } : null).on("click", c.interaction_enabled ? function (t, e) {
      var i,
          n = u.updateAngle(t);
      n && (i = u.convertToArcData(n), u.toggleShape && u.toggleShape(this, i, e), u.config.data_onclick.call(u.api, i, this));
    } : null).each(function () {
      u.transiting = !0;
    }).transition().duration(t).attrTween("d", function (i) {
      var n,
          t = u.updateAngle(i);
      return t ? (isNaN(this._current.startAngle) && (this._current.startAngle = 0), isNaN(this._current.endAngle) && (this._current.endAngle = this._current.startAngle), n = l.interpolate(this._current, t), this._current = n(0), function (t) {
        var e = n(t);
      ...
      return u.levelColor ? u.levelColor(t.data.values[0].value) : u.color(t.data.id);
    }).call(u.endall, function () {
      u.transiting = !1;
    }), n.exit().transition().duration(e).style("opacity", 0).remove(), d.selectAll("." + Y.chartArc).select("text").style("opacity", 0).attr("class", function (t) {
      return u.isGaugeType(t.data) ? Y.gaugeValue : "";
    }).text(u.textForArcLabel.bind(u)).attr("transform", u.transformForArcLabel.bind(u)).style("font-size", function (t) {
      return u.isGaugeType(t.data) && 1 === u.filterTargetsToShow(u.data.targets).length ? Math.round(u.radius / 5) + "px" : "";
    }).transition().duration(t).style("opacity", function (t) {
      return u.isTargetToShow(t.data.id) && u.isArcType(t.data) ? 1 : 0;
    }), d.select("." + Y.chartArcsTitle).style("opacity", u.hasType("donut") || h ? 1 : 0), h) {
      var g = 0;
      (r = u.arcs.select("g." + Y.chartArcsBackground).selectAll("path." + Y.chartArcsBackground).data(u.data.targets)).enter().append("path").attr("class", function (t, e) {
        return Y.chartArcsBackground + " " + Y.chartArcsBackground + "-" + e;
      }).attr("d", function (t) {
        if (0 <= u.hiddenTargetIds.indexOf(t.id)) return "M 0 0";
        var e = {
          data: [{
            value: c.gauge_max
          }],
    ...
    return function (t) {
      ...
      return n[i] instanceof Function ? e = n[i](t) : n[i] ? e = n[i] : (s.indexOf(i) < 0 && s.push(i), e = a[s.indexOf(i) % a.length], n[i] = e), r instanceof Function ? r(e, t) : e;
    };
    ...
    Object.keys(r).forEach(function (t) {
      i = e, n = t.split("_"), a = function t() {
        var e = n.shift();
        return e && i && "object" === (void 0 === i ? "undefined" : o(i)) && e in i ? (i = i[e], t()) : e ? void 0 : i;
      }(), k(a) && (r[t] = a);
    });
    ...
    var r,
        ...
        o = this,
        c = e || "csv";
    "json" === c ? (r = o.d3.json, s = o.convertJsonToData) : (r = "tsv" === c ? o.d3.tsv : o.d3.csv, s = o.convertXsvToData), r(t, i).then(function (t) {
    ...
    var a,
        ...
        r = this,
        s = [];
    return t ? (t.x ? (a = t.value.concat(t.x), r.config.data_x = t.x) : a = t.value, s.push(a), e.forEach(function (i) {
      var n = [];
      a.forEach(function (t) {
        var e = r.findValueInJson(i, t);
        v(e) && (e = null), n.push(e);
      }), s.push(n);
    }), i = r.convertRowsToData(s)) : (Object.keys(e).forEach(function (t) {
      s.push([t].concat(e[t]));
    }), i = r.convertColumnsToData(s)), i;
    ...
    for (var e = [], i = t[0], n = 1; n < t.length; n++) {
      for (var a = {}, r = 0; r < t[n].length; r++) {
        if (v(t[n][r])) throw new Error("Source data is missing a component at (" + n + "," + r + ")!");
        a[i[r]] = t[n][r];
      }
    ...
    for (var e = [], i = [], n = 0; n < t.length; n++) {
      for (var a = t[n][0], r = 1; r < t[n].length; r++) {
        if (v(e[r - 1]) && (e[r - 1] = {}), v(t[n][r])) throw new Error("Source data is missing a component at (" + n + "," + r + ")!");
        e[r - 1][a] = t[n][r];
      }
    ...
    var e,
        ...
        c = this,
        d = c.config;
    return u(t) ? r = Object.keys(t[0]) : (r = t.keys, t = t.rows), i = r.filter(c.isNotX, c), a = r.filter(c.isX, c), i.forEach(function (i) {
      var e = c.getXKey(i);
      c.isCustomX() || c.isTimeSeries() ? 0 <= a.indexOf(e) ? c.data.xs[i] = (n && c.data.xs[i] ? c.data.xs[i] : []).concat(t.map(function (t) {
        return t[e];
      ...
      return {
        ...
        values: t.map(function (t, e) {
          var i,
              n = t[c.getXKey(r)],
              a = null === t[r] || isNaN(t[r]) ? null : +t[r];
          return c.isCustomX() && c.isCategorized() && !v(n) ? (0 === s && 0 === e && (d.axis_x_categories = []), -1 === (i = d.axis_x_categories.indexOf(n)) && (i = d.axis_x_categories.length, d.axis_x_categories.push(n))) : i = c.generateTargetX(n, r, e), (v(t[r]) || c.data.xs[r].length <= e) && (i = void 0), {
            x: i,
            value: a,
            id: o
          };
    ...
    var e = this.config;
    return e.data_x && t === e.data_x || C(e.data_xs) && f(e.data_xs, t);
  }, m.isNotX = function (t) {
    return !this.isX(t);
    ...
    var t = this.config;
    return !("boolean" != typeof t.data_labels || !t.data_labels) || !("object" !== o(t.data_labels) || !C(t.data_labels));
    ...
    return t.filter(function (t) {
      ...
      var e = a.main.select("." + Y.bars + a.getTargetSelectorSuffix(t.id) + " ." + Y.bar + "-" + t.index).node();
    ...
    }), a.data.targets = a.data.targets.concat(i)), a.updateTargets(a.data.targets), a.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0,
      withLegend: !0
    }), n.done && n.done();
    ...
    if (0 < c.data_groups.length) for (s = o.hasNegativeValueInTargets(t), e = 0; e < c.data_groups.length; e++) {
      if (0 !== (a = c.data_groups[e].filter(function (t) {
        return 0 <= d.indexOf(t);
      })).length) for (n = a[0], s && u[n] && u[n].forEach(function (t, e) {
        u[n][e] = t < 0 ? t : 0;
      }), i = 1; i < a.length; i++) {
        r = a[i], u[r] && u[r].forEach(function (t, e) {
          o.axis.getId(r) !== o.axis.getId(n) || !u[n] || s && 0 < +t || (u[n][e] += +t);
        });
      }
    }
    ...
    var e,
        ...
        d = o.mapToIds(t),
        u = o.getValuesAsIdKeyed(t);
    if (0 < c.data_groups.length) for (s = o.hasPositiveValueInTargets(t), e = 0; e < c.data_groups.length; e++) {
      if (0 !== (a = c.data_groups[e].filter(function (t) {
        return 0 <= d.indexOf(t);
      })).length) for (n = a[0], s && u[n] && u[n].forEach(function (t, e) {
        u[n][e] = 0 < t ? t : 0;
    ...
    var e,
        ...
        r = this.config,
        s = t[1] - t[0];
    return i = this.isCategorized() ? 0 : this.hasType("bar") ? 1 < (e = this.getMaxDataCount()) ? s / (e - 1) / 2 : .5 : .01 * s, "object" === o(r.axis_x_padding) && C(r.axis_x_padding) ? (n = P(r.axis_x_padding.left) ? r.axis_x_padding.left : i, a = P(r.axis_x_padding.right) ? r.axis_x_padding.right : i) : n = a = "number" == typeof r.axis_x_padding ? r.axis_x_padding : i, {
      left: n,
      right: a
    };
    ...
    _.hasArcType() || r.data_selection_enabled && r.data_selection_multiple && (e = _.dragStart[0], i = _.dragStart[1], n = t[0], a = t[1], h = Math.min(e, n), g = Math.max(e, n), f = r.data_selection_grouped ? _.margin.top : Math.min(i, a), p = r.data_selection_grouped ? _.height : Math.max(i, a), s.select("." + Y.dragarea).attr("x", h).attr("y", f).attr("width", g - h).attr("height", p - f), s.selectAll("." + Y.shapes).selectAll("." + Y.shape).filter(function (t) {
      ...
      var i,
          ...
          l = !1;
      if (c.classed(Y.circle)) i = 1 * c.attr("cx"), n = 1 * c.attr("cy"), s = _.togglePoint, l = h < i && i < g && f < n && n < p;else {
        if (!c.classed(Y.bar)) return;
        i = (o = y(this)).x, n = o.y, a = o.width, r = o.height, s = _.togglePath, l = !(g < i || i + a < h || p < n || n + r < f);
      }
      l ^ u && (c.classed(Y.INCLUDED, !u), c.classed(Y.SELECTED, !d), s.call(_, !d, c, t, e));
    }));
    ...
    var n = this,
        a = t && !n.hasType("gauge") ? n.defaultArcValueFormat : n.yFormat,
        r = t && !n.hasType("gauge") ? n.defaultArcValueFormat : n.y2Format;
    ...
    var s = e.main.select("." + Y.xgrids).selectAll("." + Y.xgrid).data(a),
        o = s.enter().append("line").attr("class", Y.xgrid).attr("x1", e.xgridAttr.x1).attr("x2", e.xgridAttr.x2).attr("y1", e.xgridAttr.y1).attr("y2", e.xgridAttr.y2).style("opacity", 0);
    e.xgrid = o.merge(s), t || e.xgrid.attr("x1", e.xgridAttr.x1).attr("x2", e.xgridAttr.x2).attr("y1", e.xgridAttr.y1).attr("y2", e.xgridAttr.y2).style("opacity", e.xgridAttr.opacity), s.exit().remove();
    ...
    t.ygrid = a.merge(n), t.ygrid.attr("x1", e.axis_rotated ? t.y : 0).attr("x2", e.axis_rotated ? t.y : t.width).attr("y1", e.axis_rotated ? 0 : t.y).attr("y2", e.axis_rotated ? t.height : t.y), n.exit().remove(), t.smoothLines(t.ygrid, "grid");
    ...
    var e = this,
      ...
      return t && P(t.value);
        ...
        r = e.xx.bind(e);
    i.tooltip_show && (e.hasType("scatter") || e.hasArcType() || (a.style("visibility", "visible").data([n[0]]).attr(i.axis_rotated ? "y1" : "x1", r).attr(i.axis_rotated ? "y2" : "x2", r), e.smoothLines(a, "grid")));
    ...
    var i,
        ...
        r,
        s = [],
        o = this.main.select("." + Y.axisX).selectAll(".tick").size();
    if ("year" === t) for (n = (i = this.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), r = n; r <= a; r++) {
      s.push(new Date(r + "-01-01 00:00:00"));
    } else (s = e.ticks(10)).length > o && (s = s.filter(function (t) {
      return ("" + t).indexOf(".") < 0;
    }));
    return s;
    ...
    this.main.select("." + r).selectAll("." + s).filter(n).transition().duration(i.transition_duration).style("opacity", 0).remove(), e ? i.grid_x_lines = i.grid_x_lines.filter(a) : i.grid_y_lines = i.grid_y_lines.filter(a);
    ...
    function o() {
      a.svg.select("." + Y.eventRect).style("cursor", null), a.hideXGridFocus(), a.hideTooltip(), a.unexpandCircles(), a.unexpandBars();
    }

    t = a.width, e = a.height, a.main.select("." + Y.eventRects).style("cursor", s.zoom_enabled ? s.axis_rotated ? "ns-resize" : "ew-resize" : null), a.eventRect.attr("x", 0).attr("y", 0).attr("width", t).attr("height", e).on("mouseout", s.interaction_enabled ? function () {
      s && (a.hasArcType() || o());
    } : null).on("mousemove", s.interaction_enabled ? function () {
      var t, e, i, n;
      a.dragging || a.hasArcType(t) || (t = a.filterTargetsToShow(a.data.targets), e = r.mouse(this), i = a.findClosestFromTargets(t, e), !a.mouseover || i && i.id === a.mouseover.id || (s.data_onmouseout.call(a.api, a.mouseover), a.mouseover = void 0), i ? (n = (a.isScatterType(i) || !s.tooltip_grouped ? [i] : a.filterByX(t, i.x)).map(function (t) {
        return a.addName(t);
      }), a.showTooltip(n, this), s.point_focus_expand_enabled && (a.unexpandCircles(), n.forEach(function (t) {
        a.expandCircles(t.index, t.id, !1);
      })), a.expandBars(i.index, i.id, !0), a.showXGridFocus(n), (a.isBarType(i.id) || a.dist(i, e) < s.point_sensitivity) && (a.svg.select("." + Y.eventRect).style("cursor", "pointer"), a.mouseover || (s.data_onmouseover.call(a.api, i), a.mouseover = i))) : o());
    } : null).on("click", s.interaction_enabled ? function () {
      var t, e, i;
      a.hasArcType(t) || (t = a.filterTargetsToShow(a.data.targets), e = r.mouse(this), (i = a.findClosestFromTargets(t, e)) && (a.isBarType(i.id) || a.dist(i, e) < s.point_sensitivity) && (a.isScatterType(i) || !s.data_selection_grouped ? [i] : a.filterByX(t, i.x)).forEach(function (t) {
        a.main.selectAll("." + Y.shapes + a.getTargetSelectorSuffix(t.id)).selectAll("." + Y.shape + "-" + t.index).each(function () {
          (s.data_selection_grouped || a.isWithinShape(this, t)) && (a.toggleShape(this, t, t.index), s.data_onclick.call(a.api, t, this));
        });
      }));
    } : null).call(s.interaction_enabled && s.data_selection_draggable && a.drag ? r.drag().on("drag", function () {
      a.drag(r.mouse(this));
    }).on("start", function () {
    ...
    o.initMouseEvent(t, !0, !0, window, 0, r, s, r, s, !1, !1, !1, !1, 0, null), n.dispatchEvent(o);
    ...
    var e = this,
        i = e.config;
    i.legend_show && g(t) && (i.legend_show = !1, e.legend.style("visibility", "hidden")), e.addHiddenLegendIds(t), e.legend.selectAll(e.selectorLegends(t)).style("opacity", 0).style("visibility", "hidden");
    ...
    function R(t, e, i) {
      var n,
          ...
          o = 0 === i,
          c = i === p.length - 1,
          d = (r = t, s = e, m.legendItemTextBox[s] || (m.legendItemTextBox[s] = m.getTextRect(r.textContent, Y.legendItem, r)), m.legendItemTextBox[s]),
          u = d.width + P + (!c || m.isLegendRight || m.isLegendInset ? v : 0) + S.legend_padding,
          l = d.height + w,
          h = m.isLegendRight || m.isLegendInset ? l : u,
          g = m.isLegendRight || m.isLegendInset ? m.getLegendHeight() : m.getLegendWidth();

      function f(t, e) {
        e || (n = (g - C - h) / 2) < T && (n = (g - h) / 2, C = 0, I++), O[t] = I, E[I] = m.isLegendInset ? 10 : n, L[t] = C, C += h;
      }

      o && (A = b = I = C = 0), !S.legend_show || m.isLegendToShow(e) ? (V[e] = u, G[e] = l, (!b || b <= u) && (b = u), (!A || A <= l) && (A = l), a = m.isLegendRight || m.isLegendInset ? A : b, S.legend_equally ? (Object.keys(V).forEach(function (t) {
        V[t] = b;
      }), Object.keys(G).forEach(function (t) {
        G[t] = A;
      }), (n = (g - a * p.length) / 2) < T ? (I = C = 0, p.forEach(function (t) {
        f(t);
      })) : f(e, !0)) : f(e)) : V[e] = G[e] = O[e] = L[e] = 0;
    }

    p = p.filter(function (t) {
      return !k(S.data_names[t]) || null !== S.data_names[t];
    }), h = N(t = t || {}, "withTransition", !0), g = N(t, "withTransitionForTransform", !0), m.isLegendInset && (I = S.legend_inset_step ? S.legend_inset_step : p.length, m.updateLegendStep(I)), m.isLegendRight ? (i = function i(t) {
      return b * O[t];
    }, r = function r(t) {
      return E[O[t]] + L[t];
    }) : m.isLegendInset ? (i = function i(t) {
      return b * O[t] + 10;
    }, r = function r(t) {
      return E[O[t]] + L[t];
    }) : (i = function i(t) {
      ...
      return r(t, e) + 4;
    }, (l = m.legend.selectAll("." + Y.legendItem).data(p).enter().append("g").attr("class", function (t) {
      ...
      R(this, t, e);
    }).style("pointer-events", "none").attr("x", m.isLegendRight || m.isLegendInset ? n : -200).attr("y", m.isLegendRight || m.isLegendInset ? -200 : s), l.append("rect").attr("class", Y.legendItemEvent).style("fill-opacity", 0).attr("x", m.isLegendRight || m.isLegendInset ? a : -200).attr("y", m.isLegendRight || m.isLegendInset ? -200 : o), l.append("line").attr("class", Y.legendItemTile).style("stroke", m.color).style("pointer-events", "none").attr("x1", m.isLegendRight || m.isLegendInset ? c : -200).attr("y1", m.isLegendRight || m.isLegendInset ? -200 : u).attr("x2", m.isLegendRight || m.isLegendInset ? d : -200).attr("y2", m.isLegendRight || m.isLegendInset ? -200 : u).attr("stroke-width", S.legend_item_tile_height), y = m.legend.select("." + Y.legendBackground + " rect"), m.isLegendInset && 0 < b && 0 === y.size() && (y = m.legend.insert("g", "." + Y.legendItem).attr("class", Y.legendBackground).append("rect")), f = m.legend.selectAll("text").data(p).text(function (t) {
      return k(S.data_names[t]) ? S.data_names[t] : t;
    }).each(function (t, e) {
      R(this, t, e);
    }), (h ? f.transition() : f).attr("x", n).attr("y", s), _ = m.legend.selectAll("rect." + Y.legendItemEvent).data(p), (h ? _.transition() : _).attr("width", function (t) {
      return V[t];
    }).attr("height", function (t) {
      return G[t];
    }).attr("x", a).attr("y", o), x = m.legend.selectAll("line." + Y.legendItemTile).data(p), (h ? x.transition() : x).style("stroke", m.levelColor ? function (t) {
      return m.levelColor(m.cache[t].values[0].value);
    } : m.color).attr("x1", c).attr("y1", u).attr("x2", d).attr("y2", u), y && (h ? y.transition() : y).attr("height", m.getLegendHeight() - 12).attr("width", b * (I + 1) + 10), m.legend.selectAll("." + Y.legendItem).classed(Y.legendItemHidden, function (t) {
      return !m.isTargetToShow(t);
    }), m.updateLegendItemWidth(b), m.updateLegendItemHeight(A), m.updateLegendStep(I), m.updateSizes(), m.updateScales(), m.updateSvgSize(), m.transformAll(g, e), m.legendHasRendered = !0;
    ...
    var n = e.main.select("." + Y.regions).selectAll("." + Y.region).data(i.regions),
        a = n.enter().append("rect").attr("x", e.regionX.bind(e)).attr("y", e.regionY.bind(e)).attr("width", e.regionWidth.bind(e)).attr("height", e.regionHeight.bind(e)).style("fill-opacity", 0);
    e.mainRegion = a.merge(n).attr("class", e.classRegion.bind(e)), n.exit().transition().duration(t).style("opacity", 0).remove();
    ...
    a.data_onselected.call(n.api, e, t.node()), n.main.select("." + Y.selectedCircles + n.getTargetSelectorSuffix(e.id)).selectAll("." + Y.selectedCircle + "-" + i).data([e]).enter().append("circle").attr("class", function () {
    ...
    r.data_selection_enabled && r.data_selection_isselectable(e) && (r.data_selection_multiple || n.main.selectAll("." + Y.shapes + (r.data_selection_grouped ? n.getTargetSelectorSuffix(e.id) : "")).selectAll("." + Y.shape).each(function (t, e) {
      var i = a.select(this);
      i.classed(Y.SELECTED) && c(!1, i.classed(Y.SELECTED, !1), t, e);
    }), s.classed(Y.SELECTED, !o), c(!o, s, e, i));
  }, m.initBar = function () {
    ...
    var e = this,
      ...
      return e.color(t.id);
        ...
        s = e.main.selectAll("." + Y.bars).selectAll("." + Y.bar).data(i),
        o = s.enter().append("path").attr("class", n).style("stroke", r).style("fill", r);

    e.mainBar = o.merge(s).style("opacity", a), s.exit().transition().duration(t).style("opacity", 0);
    ...
    return function (t, e) {
      ...
      return "M " + i[0][n] + "," + i[0][a] + " L" + i[1][n] + "," + i[1][a] + " L" + i[2][n] + "," + i[2][a] + " L" + i[3][n] + "," + i[3][a] + " z";
    };
    ...
    return function (t, e) {
      var i = h.call(s, t.id)(0),
          ...
          a = c(t),
          r = d(t);
      return s.config.axis_rotated && (0 < t.value && r < i || t.value < 0 && i < r) && (r = i), [[a + l, n], [a + l, r - (i - n)], [a + o - l, r - (i - n)], [a + o - l, n]];
    };
    ...
    return this.filterTargetsToShow(this.data.targets.filter(t, this)).forEach(function (t) {
      for (e = 0; e < n.data_groups.length; e++) {
        if (!(n.data_groups[e].indexOf(t.id) < 0)) for (i = 0; i < n.data_groups[e].length; i++) {
    ...
    return function (i, n) {
      ...
      return d.forEach(function (t) {
        ...
        t.id !== i.id && o[t.id] === o[i.id] && u.indexOf(t.id) < u.indexOf(i.id) && (void 0 !== e[n] && +e[n].x == +i.x || (n = -1, e.forEach(function (t, e) {
          t.x === i.x && (n = e);
        })), n in e && 0 <= e[n].value * i.value && (s += a(e[n].value) - r));
      }), s;
    };
    ...
    var i,
        n = this,
        a = n.d3.select(t);
    return n.isTargetToShow(e.id) ? "circle" === t.nodeName ? i = n.isStepType(e) ? n.isWithinStep(t, n.getYScale(e.id)(e.value)) : n.isWithinCircle(t, 1.5 * n.pointSelectR(e)) : "path" === t.nodeName && (i = !a.classed(Y.bar) || n.isWithinBar(n.d3.mouse(t), t)) : i = !1, i;
    ...
    (e = i.main.select("." + Y.chartLines).selectAll("." + Y.chartLine).data(t).attr("class", function (t) {
      return a(t) + c(t);
    }).enter().append("g").attr("class", a).style("opacity", 0).style("pointer-events", "none")).append("g").attr("class", r), e.append("g").attr("class", s), e.append("g").attr("class", function (t) {
      return i.generateClass(Y.selectedCircles, t.id);
    }), e.append("g").attr("class", o).style("cursor", function (t) {
    ...
    var c = this,
      ...
      return (o ? c.subxx : c.xx).call(c, t);
        ...
        n = function n(t, e) {
      return 0 < d.data_groups.length ? i(t, e)[0][1] : l.call(c, t.id)(t.value);
    };

    return u = d.axis_rotated ? u.x(n).y(e) : u.x(e).y(n), d.line_connectNull || (u = u.defined(function (t) {
      return null != t.value;
    })), function (t) {
      var e,
          i = d.line_connectNull ? c.filterRemoveNull(t.values) : t.values,
          n = o ? c.subX : c.x,
          a = l.call(c, t.id),
          r = 0,
          s = 0;
      return c.isLineType(t) ? d.data_regions[t.id] ? e = c.lineWithRegions(i, n, a, d.data_regions[t.id]) : (c.isStepType(t) && (i = c.convertValuesToStep(i)), e = u.curve(c.getInterpolate(t))(i)) : (i[0] && (r = n(i[0].x), s = a(i[0].value)), e = d.axis_rotated ? "M " + s + " " + r : "M " + r + " " + s), e || "M 0 0";
    };
    ...
    return function (t, e) {
      var i = l.call(s, t.id)(0),
          ...
          a = c(t),
          r = d(t);
      return o.axis_rotated && (0 < t.value && r < i || t.value < 0 && i < r) && (r = i), [[a, r - (i - n)], [a, r - (i - n)], [a, r - (i - n)], [a, r - (i - n)]];
    };
    ...
    if (k(e)) for (i = 0; i < e.length; i++) {
      m[i] = {}, v(e[i].start) ? m[i].start = t[0].x : m[i].start = p.isTimeSeries() ? p.parseDate(e[i].start) : e[i].start, v(e[i].end) ? m[i].end = t[t.length - 1].x : m[i].end = p.isTimeSeries() ? p.parseDate(e[i].end) : e[i].end;
    }
    ...
    for (g = _.axis_rotated ? function (t) {
      ...
      return c(t.x);
    }, f = _.axis_rotated ? function (t) {
      return c(t.x);
    } : function (t) {
      return d(t.value);
    }, a = p.isTimeSeries() ? function (t, e, i, n) {
      var a = t.x.getTime(),
          r = e.x - t.x,
          s = new Date(a + r * i),
          o = new Date(a + r * (i + n));
      return w(_.axis_rotated ? [[d(u(i)), c(s)], [d(u(i + n)), c(o)]] : [[c(s), d(u(i))], [c(o), d(u(i + n))]]);
    } : function (t, e, i, n) {
      return w(_.axis_rotated ? [[d(u(i), !0), c(r(i))], [d(u(i + n), !0), c(r(i + n))]] : [[c(r(i), !0), d(u(i))], [c(r(i + n), !0), d(u(i + n))]]);
    }, i = 0; i < t.length; i++) {
      if (v(m) || !S(t[i].x, m)) x += " " + g(t[i]) + " " + f(t[i]);else for (r = p.getScale(t[i - 1].x + y, t[i].x + y, p.isTimeSeries()), u = p.getScale(t[i - 1].value, t[i].value), s = c(t[i].x) - c(t[i - 1].x), o = d(t[i].value) - d(t[i - 1].value), h = 2 * (l = 2 / Math.sqrt(Math.pow(s, 2) + Math.pow(o, 2))), n = l; n <= 1; n += h) {
        x += a(t[i - 1], t[i], n, l);
      }
      t[i].x;
    }
    ...
    var e = this,
        ...
        a = n.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity", function () {
      return e.orgAreaOpacity = +i.select(this).style("opacity"), 0;
    });
    e.mainArea = a.merge(n).style("opacity", e.orgAreaOpacity), n.exit().transition().duration(t).style("opacity", 0);
    ...
    var r = this,
      ...
      return (e ? r.subxx : r.xx).call(r, t);
        ...
        c = function c(t, e) {
      return 0 < s.data_groups.length ? i(t, e)[0][1] : n.call(r, t.id)(r.getAreaBaseValue(t.id));
    },
        d = function d(t, e) {
      return 0 < s.data_groups.length ? i(t, e)[1][1] : n.call(r, t.id)(t.value);
    };

    return o = s.axis_rotated ? o.x0(c).x1(d).y(a) : o.x(a).y0(s.area_above ? 0 : c).y1(d), s.line_connectNull || (o = o.defined(function (t) {
      return null !== t.value;
    })), function (t) {
      var e,
          i = s.line_connectNull ? r.filterRemoveNull(t.values) : t.values,
          n = 0,
          a = 0;
      return r.isAreaType(t) ? (r.isStepType(t) && (i = r.convertValuesToStep(i)), e = o.curve(r.getInterpolate(t))(i)) : (i[0] && (n = r.x(i[0].x), a = r.getYScale(t.id)(i[0].value)), e = s.axis_rotated ? "M " + a + " " + n : "M " + n + " " + a), e || "M 0 0";
    };
    ...
    return function (t, e) {
      var i = l.call(s, t.id)(0),
          ...
          a = c(t),
          r = d(t);
      return o.axis_rotated && (0 < t.value && r < i || t.value < 0 && i < r) && (r = i), [[a, n], [a, r - (i - n)], [a, r - (i - n)], [a, n]];
    };
  }, m.updateCircle = function (t, e) {
    var i = this,
        n = i.main.selectAll("." + Y.circles).selectAll("." + Y.circle).data(i.lineOrScatterData.bind(i)),
        a = n.enter().append("circle").attr("class", i.classCircle.bind(i)).attr("cx", t).attr("cy", e).attr("r", i.pointR.bind(i)).style("fill", i.color);
    i.mainCircle = a.merge(n).style("opacity", i.initialOpacityForCircle.bind(i)), n.exit().style("opacity", 0);
  }, m.redrawCircle = function (t, e, i, n) {
    var a = this,
        r = a.main.selectAll("." + Y.selectedCircle);
    return [(i ? a.mainCircle.transition(n) : a.mainCircle).style("opacity", this.opacityForCircle.bind(a)).style("fill", a.color).attr("cx", t).attr("cy", e), (i ? r.transition(n) : r).attr("cx", t).attr("cy", e)];
    ...
    var e = this.config;
    return P(e.padding_left) ? e.padding_left : e.axis_rotated ? !e.axis_x_show || e.axis_x_inner ? 1 : Math.max(d(this.getAxisWidthByAxisId("x", t)), 40) : !e.axis_y_show || e.axis_y_inner ? this.axis.getYAxisLabelPosition().isOuter ? 30 : 1 : d(this.getAxisWidthByAxisId("y", t));
  }, m.getCurrentPaddingRight = function () {
    var t = this,
        e = t.config,
        i = t.isLegendRight ? t.getLegendWidth() + 20 : 0;
    return P(e.padding_right) ? e.padding_right + 1 : e.axis_rotated ? 10 + i : !e.axis_y2_show || e.axis_y2_inner ? 2 + i + (t.axis.getY2AxisLabelPosition().isOuter ? 20 : 0) : d(t.getAxisWidthByAxisId("y2")) + i;
    ...
    var a = this,
        e = a.d3;
    return a.brush = (a.config.axis_rotated ? e.brushY() : e.brushX()).on("brush", function () {
      var t = e.event.sourceEvent;
      t && "zoom" === t.type || a.redrawForBrush();
    }).on("end", function () {
      var t = e.event.sourceEvent;
      t && "zoom" === t.type || a.brush.empty() && t && "end" !== t.type && a.brush.clear();
    }), a.brush.updateExtent = function () {
      var t,
          e = this.scale.range();
      return t = a.config.axis_rotated ? [[0, e[0]], [a.width2, e[1]]] : [[e[0], 0], [e[1], a.height2]], this.extent(t), this;
    }, a.brush.updateScale = function (t) {
      return this.scale = t, this;
    }, a.brush.update = function (t) {
      this.updateScale(t || a.subX).updateExtent(), a.context.select("." + Y.brush).call(this);
    }, a.brush.clear = function () {
      a.context.select("." + Y.brush).call(a.brush.move, null);
    }, a.brush.selection = function () {
      return e.brushSelection(a.context.select("." + Y.brush).node());
    }, a.brush.selectionAsValue = function (t, e) {
      var i, n;
      return t ? (a.context && (i = [this.scale(t[0]), this.scale(t[1])], n = a.context.select("." + Y.brush), e && (n = n.transition()), a.brush.move(n, i)), []) : (i = a.brush.selection() || [0, 0], [this.scale.invert(i[0]), this.scale.invert(i[1])]);
    ...
    n.exit().transition().duration(t).style("opacity", 0).remove(), e.contextArea = a.merge(n).style("opacity", 0);
    ...
    var e = this,
        ...
        r = e.main.select("." + Y.chartTexts).selectAll("." + Y.chartText).data(t),
        s = r.enter().append("g").attr("class", i).style("opacity", 0).style("pointer-events", "none");
    s.append("g").attr("class", n), s.merge(r).attr("class", function (t) {
      return i(t) + a(t);
    });
    ...
    var n = this,
        ...
        o = n.main.selectAll("." + Y.texts).selectAll("." + Y.text).data(r),
        c = o.enter().append("text").attr("class", s).attr("text-anchor", function (t) {
    ...
    }), o.exit().transition().duration(i).style("fill-opacity", 0).remove();
    ...
    for (p && t.sort(p), r = 0; r < t.length; r++) {
      if (t[r] && (t[r].value || 0 === t[r].value) && (a || (s = _(h ? h(t[r].x) : t[r].x), a = "<table class='" + u.CLASS.tooltip + "'>" + (s || 0 === s ? "<tr><th colspan='2'>" + s + "</th></tr>" : "")), void 0 !== (o = _(f(t[r].value, t[r].ratio, t[r].id, t[r].index, t))))) {
        if (null === t[r].name) continue;
        c = _(g(t[r].name, t[r].ratio, t[r].id, t[r].index)), d = u.levelColor ? u.levelColor(t[r].value) : n(t[r].id), a += "<tr class='" + u.CLASS.tooltipName + "-" + u.getTargetSelectorSuffix(t[r].id) + "'>", a += "<td class='name'><span style='background-color:" + d + "'></span>" + c + "</td>", a += "<td class='value'>" + o + "</td>", a += "</tr>";
      }
    }
    ...
    0 !== c.length && s.tooltip_show && (r.tooltip.html(s.tooltip_contents.call(r, t, r.axis.getXAxisTickFormat(), r.getYFormat(o), r.color)).style("display", "block"), i = r.tooltip.property("offsetWidth"), n = r.tooltip.property("offsetHeight"), a = d.call(this, c, i, n, e), r.tooltip.style("top", a.top + "px").style("left", a.left + "px"));
    ...
    return (t = t || this.data.targets) && t.length ? t.forEach(function (t) {
      var e = n[t.id];
      (e && 0 <= e.indexOf(i) || !e && "line" === i) && (a = !0);
    }) : Object.keys(n).length ? Object.keys(n).forEach(function (t) {
      n[t] === i && (a = !0);
    }) : a = this.config.data_type === i, a;
    ...
    return i.zoom = n.zoom().on("start", function () {
      ...
      t && "brush" === t.type || (e = t, a.zoom_onzoomstart.call(i.api, t));
    }).on("zoom", function () {
      var t = n.event.sourceEvent;
      t && "brush" === t.type || i.redrawForZoom.call(i);
    }).on("end", function () {
      var t = n.event.sourceEvent;
      t && "brush" === t.type || t && e.clientX === t.clientX && e.clientY === t.clientY || a.zoom_onzoomend.call(i.api, i.x.orgDomain());
      ...
      return this.scaleExtent([1, 1 / 0]).translateExtent([[0, 0], [i.width, i.height]]).extent([[0, 0], [i.width, i.height]]), this;
...
//# sourceMappingURL=c3.min.js.map
