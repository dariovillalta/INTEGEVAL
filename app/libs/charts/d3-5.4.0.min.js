...
(function (t, n) {
  ...
  function it(t, n, e) {
    ...
    return function (i, o, a) {
      var u,
          f = this.__on,
          c = r(n, o, a);
      if (f) for (var s = 0, l = f.length; s < l; ++s) {
  ...
  function _n(t, n) {
    var e,
        ...
        l = f - o,
        h = s * s + l * l;
    if (h < pl) r = Math.log(c / a) / ll, e = function e(t) {
  ...
  function Go(t) {
    ...
    t: for (u = 3; u < i; ++u) {
      ...
      for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Ho(n); (r = r.next) !== e;) {
        (a = Ho(r)) < o && (n = r, o = a);
      }
  ...
  function Lc(t) {
    ...
    for (var f = o; f.circle && Math.abs(e - f.circle.x) < ob && Math.abs(r - f.circle.cy) < ob;) {
      o = f.P, u.unshift(f), Rc(f), f = o;
    }

    u.unshift(f), Pc(f);

    for (var c = a; c.circle && Math.abs(e - c.circle.x) < ob && Math.abs(r - c.circle.cy) < ob;) {
  ...
  ut.prototype = ft.prototype = {
    ...
    on: function on(t, n, e) {
      ...
      if (u) for (var f, c = 0, s = u.length; c < s; ++c) {
        for (r = 0, f = u[c]; r < a; ++r) {
  ...
  Bf.prototype = {
    ...
    lineEnd: function lineEnd() {
      var t = this._x,
          n = this._y,
          e = t.length - 1;
      if (e > 0) for (var r, i = t[0], o = n[0], a = t[e] - i, u = n[e] - o, f = -1; ++f <= e;) {
  ...
  Jf.prototype = {
    ...
    lineEnd: function lineEnd() {
      var t = this._x,
          n = this._y,
          e = t.length;
      if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);else for (var r = uc(t), i = uc(n), o = 0, a = 1; a < e; ++o, ++a) {
  ...
  Ic.prototype = Fc.prototype, t.version = "5.4.0", t.bisect = Jc, t.bisectRight = Jc, t.bisectLeft = Kc, t.ascending = n, t.bisector = e, t.cross = function (t, n, e) {
    ...
    function t(n, i, a, u) {
      ...
      for (var f, c, s, l = -1, h = n.length, d = o[i++], p = he(), v = a(); ++l < h;) {
...
//# sourceMappingURL=d3-5.4.0.min.js.map
