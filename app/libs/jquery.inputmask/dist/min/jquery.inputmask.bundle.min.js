...
!function (a) {
  ...
  function g(c, d) {
    function e(b) {
      ...
      for (var j, k, l, m, n, o, p, q = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g, r = !1, s = new d(), t = [], u = []; j = q.exec(b);) {
        if (k = j[0], r) h();else switch (k.charAt(0)) {
          case c.escapeChar:
            r = !0;
            break;
  ...
  function h(e, f, g) {
            ...
            if (f.isGroup && o !== f) {
              ...
              if (-1 === y || "string" == typeof y) {
                var z,
                    ...
                    B = d.slice(),
                    C = [];
                if ("string" == typeof y) C = y.split(",");else for (z = 0; z < t.matches.length; z++) {
                  C.push(z);
                }
    ...
    function y(a, b, c) {
      var d;
      if (c = c, a === !0) n(), a = 0, b = c.length;else for (d = a; b > d; d++) {
    ...
    function B(c, d, e, f) {
                ...
                if (w < v[x]) {
                  ...
                  if (w !== C.locator[h]) {
                    for (k = t + 1; k < o(void 0, !0) + 1; k++) {
                      l = m().validPositions[k], l && null != l.match.fn ? y.push(l.input) : b > k && z++, delete m().validPositions[k], delete m().tests[k];
                    }
      ...
      for (w++; l > w; w++) {
        void 0 === m().validPositions[w] && (g.jitMasking === !1 || g.jitMasking > w) && ((F = r(w)).match.def === g.radixPointDefinitionSymbol || !C(w, !0) || a.inArray(g.radixPoint, x()) < w && F.match.fn && F.match.fn.test(I(w), m(), w, !1, g)) && i(o(w, !0) + 1, F.match.placeholder || (null == F.match.fn ? F.match.def : "" !== I(w) ? I(w) : x()[w]), !0, f);
      }
      ...
      if (null === b.fn) {
        if (a > -1 && !g.keepStatic && void 0 === m().validPositions[a]) {
          var c,
              d = v(a),
              e = [];
          if (d.length > 2) for (var f = 0; f < d.length; f++) {
            if (d[f].match.optionality !== !0 && d[f].match.optionalQuantifier !== !0 && (null === d[f].match.fn || void 0 === c || d[f].match.fn.test(c.match.def, m(), a, !0, g) !== !1) && (e.push(d[f]), null === d[f].match.fn && (c = d[f]), e.length > 1)) return g.placeholder.charAt(a % g.placeholder.length);
          }
        }
    ...
    function M(b) {
      ...
      for (c = f - 1; c > g && (d = h[c], (d.match.optionality || d.match.optionalQuantifier || k && (k !== h[c].locator[i.alternation] && null != d.match.fn || null === d.match.fn && d.locator[i.alternation] && A(d.locator[i.alternation].toString().split(","), k.toString().split(",")) && "" !== v(c)[0].def)) && e[c] === I(c, d.match)); c--) {
        f--;
      }
  ...
  return b.extendAliases({
    numeric: {
      ...
      autoUnmask: !1,
      unmaskAsNumber: !1,
      postFormat: function postFormat(c, d, e) {
        ...
        if (l.length > 0 && e.autoGroup || -1 !== l.indexOf(e.groupSeparator)) {
          ...
          if (l = "" === e.radixPoint ? l : o[0], l !== e.prefix + "?0" && l.length >= e.groupSize + e.prefix.length) for (var p = new RegExp("([-+]?[\\d?]+)([\\d?]{" + e.groupSize + "})"); p.test(l) && "" !== e.groupSeparator;) {
        ...
        var q = a.inArray("?", c);
        if (-1 === q && (q = a.inArray(j, c)), c[q] = j, !i && h) for (f = 0, g = e.suffix.length; g > f; f++) {
      ...
      definitions: {
        "~": {
          validator: function validator(c, d, e, f, g, h) {
              ...
              for (var e = 0; e < b.matches.length; e++) {
                ...
                if (f.isGroup === !0) d = i(f, !0);else if (f.isQuantifier === !0) {
                  ...
                  if ("[" == f.charAt(0)) {
                    ...
                    var s = new RegExp("^(" + q + ")$");
                    d = s.test(j);
                  } else for (var t = 0, u = f.length; u > t; t++) {
                    if ("\\" !== f.charAt(t)) {
