                                        ...
                                        <div className={"row border-top border-bottom addPaddingToConfig"}>
                                            ...
                                            <div className={"row"} style={{width: "100%"}}>
                                                ...
                                                <div className={"col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2"}>
                                                    <a onClick={() => this.props.editarRiesgo(riesgo.ID, riesgo.idFormula, riesgo.nombre, riesgo.peso, riesgo.formula, riesgo.responsable)}className="btn btn-success" style={{color: "white"}}>Editar</a>
                                                </div>
                                                <div className={"col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2"}>
