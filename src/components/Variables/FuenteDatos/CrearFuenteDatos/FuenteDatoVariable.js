...
export default class FuenteDatoVariable extends React.Component {
    constructor(props) {
        ...
        this.revisarSeleccionCampoOperacionAntesCondiciones = this.revisarSeleccionCampoOperacionAntesCondiciones.bind(this);
    }
            ...
            if(operacionSeleccionada.valor != undefined) {
                if(this.state.reglas.length == 0) {
                    ...
                    ATRIBUTOS REGLA
                        ...
                        -nivel
                    */
                    var nuevaRegla = {esFuenteDato: true};
                }
                this.props.goToCreateConditions();
            } else {
                alert("Seleccione por lo menos una operación");
            }
        } else {
            alert("Seleccione por lo menos una columna");
        }
    }
        ...
        return (
            <div>
                ...
                <div className={"row"} style={{width: "100%", border: "1px solid #e6e6f2"}}>
                    <CrearFuenteDatosAtributos atributos={this.state.atributos} campos={this.props.campos}
                                                        ...
                                                        goToCreateConditions={this.revisarSeleccionCampoOperacionAntesCondiciones}>
                    </CrearFuenteDatosAtributos>
                </div>
                <br/>
