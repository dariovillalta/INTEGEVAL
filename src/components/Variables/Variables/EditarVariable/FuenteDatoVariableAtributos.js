                        ...
                        { this.props.mostrarInstruccionSQL ? (
                            ...
                            <div className={"row"}>
                                <div className={"col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"}>
                                    ...
                                    <br/>
                                    <a className={"btn btn-success btn-block btnWhiteColorHover font-bold font-20"} style={{color: "#fafafa"}} onClick={() => this.actualizarIndiceAtributoSeleccionado(0)}>Crear Instrucción Personalizada </a>
                                    <br/>
                                </div>
                            </div>
                        )}
