                                ...
                                <div className={"page-breadcrumb"}>
                                    <nav aria-label="breadcrumb">
                                        <ol className={"breadcrumb"}>
                                            ...
                                            <li className={"breadcrumb-item active font-16"} aria-current="page">Seleccionar Lista</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div className={"page-header"}>
                                ...
                                <div className={"page-breadcrumb"}>
                                    <nav aria-label="breadcrumb">
                                        <ol className={"breadcrumb"}>
                                            <li className={"breadcrumb-item font-16"} aria-current="page" onClick={this.props.configuracionHome}><a href="#" className={"breadcrumb-link"}>Configuraci&oacute;n</a></li>
                                            <li className={"breadcrumb-item font-16"} aria-current="page" onClick={this.regresarSeleccionarLista}><a href="#" className={"breadcrumb-link"}>Seleccionar Lista</a></li>
                                            <li className={"breadcrumb-item active font-16"} aria-current="page">Seleccionar Lista</li>
                                        </ol>
                                    </nav>
                                </div>
